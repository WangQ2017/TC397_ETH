...
# if ((DEM_CFG_DATA_DAG_EXTENDED_ENV_DATA == STD_ON) || (DEM_CFG_DATA_DAG_STANDARD_ENV_DATA == STD_ON))
#  error "Event combination Type 2 is currently not supported together with DAG Standard Environmental Data Elements"
# endif
