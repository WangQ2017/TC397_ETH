...
#define DEM_DEBOUNCE_IMPLEMENTATION_FILENAME "Dem_Debounce_Implementation.h"
  ...
  )
{
  ...
  default:
    ...
    {
      Dem_Error_RunTimeCheckFailed(DEM_DEBOUNCE_IMPLEMENTATION_FILENAME, __LINE__);                                              /* SBSW_DEM_POINTER_RUNTIME_CHECK */
    } 
