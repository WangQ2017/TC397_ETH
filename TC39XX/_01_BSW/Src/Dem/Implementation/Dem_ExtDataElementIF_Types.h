 ...
 *********************************************************************************************************************/
typedef Dem_DataReportIF_CopyDidInfoType    Dem_ExtDataElementIF_CollectDidInfoType;
typedef Dem_DataReportIF_CopyDidInfoPtrType Dem_ExtDataElementIF_CollectDidInfoPtrType;
