...
#define DEM_DATASTORAGEIF_IMPLEMENTATION_FILENAME "Dem_DataStorageIF_Implementation.h"
...
# if (DEM_CFG_SUPPORT_TIME_SERIES_PAST_NORMAL == STD_ON)
  ...
  {
    Dem_Mem_SetSampleCountNormal(Dem_Mem_GetSampleCountNormal() + 1u);
  }
...
# if (DEM_CFG_SUPPORT_TIME_SERIES_PAST_FAST == STD_ON)
  ...
  {
    Dem_Mem_SetSampleCountFast(Dem_Mem_GetSampleCountFast() + 1u);
  }
