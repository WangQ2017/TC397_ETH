...
#define DEM_DTR_IMPLEMENTATION_FILENAME "Dem_Dtr_Implementation.h"
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  ...
  {
    Dem_Error_RunTimeCheckFailed(DEM_DTR_IMPLEMENTATION_FILENAME, __LINE__);                                                     /* SBSW_DEM_POINTER_RUNTIME_CHECK */
  }
  else
# endif
  {
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Dtr_SetTestValue(                                                                                                            /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONST(DTRIdType, AUTOMATIC)  DtrId,
  CONST(uint16, AUTOMATIC)  Value
  )
{
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Dtr_SetLowerLimit(                                                                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONST(DTRIdType, AUTOMATIC)  DtrId,
  CONST(uint16, AUTOMATIC)  Value
  )
{
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Dtr_SetUpperLimit(                                                                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONST(DTRIdType, AUTOMATIC)  DtrId,
  CONST(uint16, AUTOMATIC)  Value
  )
{
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Dtr_SetWriteOnShutdown(                                                                                                    /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
  )
{
  ...
  )
{
  ...
  if (Dem_Dtr_GetUaSId(DTRId) < 0x80U)
  {
  ...
  {
    if (Dem_Dtr_ConvertValue(DTRId, LowerLimit, lGlobalLowerLimit, lGlobalUpperLimit, &lConvLowerLimit) != DEM_DTR_CONVERSION_OK)/* SBSW_DEM_POINTER_FORWARD_STACK */
    {
  ...
  {
    if (Dem_Dtr_ConvertValue(DTRId, UpperLimit, lGlobalLowerLimit, lGlobalUpperLimit, &lConvUpperLimit) != DEM_DTR_CONVERSION_OK)/* SBSW_DEM_POINTER_FORWARD_STACK */
    {
      lDTRProcessingStatus = E_NOT_OK;
    }
  }
  ...
  if (lDTRProcessingStatus == E_OK)
  {
    ...
    lGlobalLimitResult = Dem_Dtr_ConvertValue(DTRId, TestResult, lGlobalLowerLimit, lGlobalUpperLimit, &lConvTestResult);        /* SBSW_DEM_POINTER_FORWARD_STACK */
    ...
    case DEM_DTR_CONVERSION_UNDERFLOW:
      if (Ctrlval != DEM_DTR_CTL_NO_MIN)
      {
        lDTRProcessingStatus = Dem_Dtr_ShiftThresholds(lConvTestResult,                                                          /* SBSW_DEM_POINTER_FORWARD_STACK */
  ...
  if (lDTRProcessingStatus == E_OK)
  {
    Dem_Dtr_SetDtrValues(DTRId, (uint16)lConvTestResult, (uint16)lConvLowerLimit, (uint16)lConvUpperLimit);                      /* PRQA S 2897 */ /* MD_DEM_2897 */
  }
...
# endif
    Dem_Dtr_SetDtrValues(DTRId, 0u, 0u, 0u);
  }
 ...
 */
DEM_LOCAL FUNC(boolean, DEM_CODE)
Dem_Dtr_IsEventAvailable(                                                                                                        /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONST(DTRIdType, AUTOMATIC) DtrId
  )
{
...
{
  if (Dem_Dtr_TestWriteOnShutdown() == TRUE)
  {
    Dem_Dtr_ResetWriteOnShutdown();
    Dem_Nvm_SetSingleBlockState(Dem_Nvm_GetSingleBlockId(DEM_NVM_BLOCKTYPE_DTR), 
                                DEM_NVM_BLOCKSTATE_DIRTY);
  ...
  )
{
  ...
  for (Dem_Dtr_EventDtrIterInit(EventId, &lDtrIter);                                                                             /* SBSW_DEM_CALL_ITERATOR_POINTER */
    Dem_Dtr_EventDtrIterExists(&lDtrIter) == TRUE;                                                                               /* SBSW_DEM_CALL_ITERATOR_POINTER */ /* PRQA S 2994 */ /* MD_DEM_2994 */
  ...
  )
{
  ...
  for (lDtrId = 0u; lDtrId < Dem_Dtr_GetGlobalDtrCount(); lDtrId++)
  {
  ...
  )
{
  ...
  if ( (Dem_Dtr_IsValidHandle(DTRId) == TRUE)
    && (Dem_Dtr_IsEventAvailable(DTRId) == TRUE) )                                                                               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    switch (Ctrlval)
    {
  ...
  )
{
  return (boolean)( (Dem_Dtr_GetStatus(DTRId) == DEM_DTR_VISIBLE)
                 && (Dem_Dtr_IsEventAvailable(DTRId) == TRUE)                                                                    /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
                 && (Dem_Dtr_IsDTCSuppressed(DTRId) == FALSE) );                                                                 /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
}
#endif
