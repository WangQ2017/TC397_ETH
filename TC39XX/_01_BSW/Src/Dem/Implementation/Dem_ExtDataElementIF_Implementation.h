...
#define DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME "Dem_ExtDataElementIF_Implementation.h"
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  ...
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
  }
  else
# endif
  {
  ...
  )
{
  ...
  CollectDidInfoPtr->ReadIndex = 0u;                                                                                              /* SBSW_DEM_CALL_COLLECTDIDINFO_INIT */
}
#endif
...
Dem_ExtDataElementIF_CollectDataElement(
  CONST(Dem_ExtDataElementIF_CollectDidInfoPtrType, AUTOMATIC)  CollectDidInfoPtr,                                               /* PRQA S 3673 */ /* MD_DEM_8.13_Design */
  CONST(Dem_Cfg_DataIndexType, AUTOMATIC)  DataIndex
  )
{
