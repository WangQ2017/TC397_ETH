 ...
 */
/* ****************************************************************************
 * Dem_Dcm_ERec_0x1916_GlobalERecIter_Exists
 *****************************************************************************/
/*!
 ...
 *
 * \return        TRUE
 *                Return value of Dem_Dcm_ERec_0x1916_GlobalERecIter_Get() is valid
 * \return        FALSE
 *                Return value of Dem_Dcm_ERec_0x1916_GlobalERecIter_Get() is invalid
 *
...
Dem_Dcm_ERec_0x1916_GlobalERecIter_Exists(
  CONSTP2CONST(Dem_Dcm_ERec_0x1916_GlobalERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
);

/* ****************************************************************************
 * Dem_Dcm_ERec_0x1916_GlobalERecIter_Get
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_Dcm_ERec_0x1916_GlobalERecIter_Init
 *****************************************************************************/
/*!
...
Dem_Dcm_ERec_0x1916_GlobalERecIter_Init(
  ...
  CONSTP2VAR(Dem_Dcm_ERec_0x1916_GlobalERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
);

/* ****************************************************************************
* Dem_Dcm_ERec_0x1916_GlobalERecIter_Invalidate
*****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_Dcm_ERec_0x1916_GlobalERecIter_Next
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 % Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Exists
 *****************************************************************************/
/*!
 * \brief         Test if the iterator points to a valid element
 *
...
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Exists(
  CONSTP2CONST(Dem_Dcm_ERec_0x1916_DataCollectionERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
);

/* ****************************************************************************
 % Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Get
 *****************************************************************************/
/*!
 * \brief         Get the element pointed to by the iterator
 *
...
/* ****************************************************************************
 % Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Init
 *****************************************************************************/
/*!
 * \brief         Initialize the iterator
 *
...
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Init(
  CONSTP2VAR(Dem_Dcm_ERec_0x1916_DataCollectionERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
);

/* ****************************************************************************
 % Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Next
 *****************************************************************************/
/*!
 * \brief         Move the iterator to the next element
 *
...
/* ****************************************************************************
 * Dem_Dcm_ERec_0x1916_FindDataCollectionTableIndexByRecordnumber
 *****************************************************************************/
/*!
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Dcm_ERec_0x1916_GlobalERecIter_Exists(                                                                                        /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONSTP2CONST(Dem_Dcm_ERec_0x1916_GlobalERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
)
{
...
)
{
  ...
  return Dem_Cfg_GetEventTable_GlobalERec2EventIdInd(IterPtr->mIdx);
}
...
)
{
  ...
  IterPtr->mIdx = Dem_Cfg_GetEventTable_GlobalERec2EventIdIndStartIdxOfDataCollectionTable(ERecDataCollectionTableIndex);        /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
  IterPtr->mEndIdx = Dem_Cfg_GetEventTable_GlobalERec2EventIdIndEndIdxOfDataCollectionTable(ERecDataCollectionTableIndex);       /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
}
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Dcm_ERec_0x1916_GlobalERecIter_Next(                                                                                          /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONSTP2VAR(Dem_Dcm_ERec_0x1916_GlobalERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr                                              /* PRQA S 3673 */ /* MD_DEM_8.13_fp */
)
{
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Exists(                                                                               /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONSTP2CONST(Dem_Dcm_ERec_0x1916_DataCollectionERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
)
{
  return (boolean)(IterPtr->mIdx < IterPtr->mEndIdx);
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_Cfg_DidIndexType, DEM_CODE)
Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Get(                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONSTP2CONST(Dem_Dcm_ERec_0x1916_DataCollectionERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
)
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(IterPtr)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Init(                                                                                 /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONSTP2VAR(Dem_Dcm_ERec_0x1916_DataCollectionERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
)
{
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Next(                                                                                 /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONSTP2VAR(Dem_Dcm_ERec_0x1916_DataCollectionERecIterType, AUTOMATIC, AUTOMATIC) IterPtr                                       /* PRQA S 3673 */ /* MD_DEM_8.13_fp */
)
{
  IterPtr->mIdx += 1u;                                                                                                           /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
}
...
{
  Dem_Dcm_ERec_0x1916_GlobalERecIter_Init(ExtendedDataFilterPtr->DataCollectionTableIdx,                                         /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
        &(ExtendedDataFilterPtr->GlobalERecIterator));
  ExtendedDataFilterPtr->MemoryIndexIter = DEM_MEM_INVALID_MEMORY_INDEX;                                                         /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
}
...
)
{
  ...
  ExtendedDataFilterPtr->MemoryIndexIter = Dem_Memory_MemEntry_IterGetMemoryIndex(&lPrimaryEventEntryIter);                      /* SBSW_DEM_POINTER_WRITE_ARGUMENT */ /* SBSW_DEM_POINTER_FORWARD_STACK */

  Dem_Dcm_ERec_0x1916_GlobalERecIter_Invalidate(&(ExtendedDataFilterPtr->GlobalERecIterator));                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
...
{
  uint16 lERecCount;
  Dem_Dcm_ERec_0x1916_GlobalERecIterType lERecIter;

  lERecCount = 0;
  for (Dem_Dcm_ERec_0x1916_GlobalERecIter_Init(ERecDataCollectionTableIdx, &lERecIter);                                           /* SBSW_DEM_CALL_ITERATOR_POINTER */
       Dem_Dcm_ERec_0x1916_GlobalERecIter_Exists(&lERecIter) == TRUE;                                                             /* PRQA S 2994 */ /* MD_DEM_2994 */ /* SBSW_DEM_CALL_ITERATOR_POINTER */
       Dem_Dcm_ERec_0x1916_GlobalERecIter_Next(&lERecIter))                                                                       /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    Dem_EventIdType lEventId;
    lEventId = Dem_Dcm_ERec_0x1916_GlobalERecIter_Get(&lERecIter);                                                                /* SBSW_DEM_POINTER_FORWARD_STACK */
...
)
{
  ...
  for (/*Already initialzed on SetFilter - */;                                                                                   /* SBSW_DEM_CALL_ITERATOR_POINTER */
      (Dem_Dcm_ERec_0x1916_GlobalERecIter_Exists(&lERecNumberFilter.GlobalERecIterator) == TRUE);                                /* SBSW_DEM_CALL_ITERATOR_POINTER */
       Dem_Dcm_ERec_0x1916_GlobalERecIter_Next(&lERecNumberFilter.GlobalERecIterator))                                           /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    Dem_EventIdType lEventId;
    lEventId = Dem_Dcm_ERec_0x1916_GlobalERecIter_Get(&lERecNumberFilter.GlobalERecIterator);                                    /* SBSW_DEM_CALL_ITERATOR_POINTER */
        ...
        if (lReturnValue != DEM_NO_SUCH_ELEMENT)
        {
          if (lReturnValue == E_OK)
          {
            ...
            *BufSize = lDestinationBuffer.WriteIndex;                                                                            /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
            Dem_Dcm_ERec_0x1916_GlobalERecIter_Next(&lERecNumberFilter.GlobalERecIterator);                                      /* PRQA S 2469 */ /* MD_DEM_14.2_LoopControlHandledInternally */ /* SBSW_DEM_CALL_ITERATOR_POINTER */
          }
...
)
{
  ...
  lERecNumberFilter = Dem_Dcm_ERec_0x1916_GetRecordNumberFilter(ExtendedDataFilterId);
  lStoredMemoryIndex = lERecNumberFilter.MemoryIndexIter;
...
# endif
  ...
  lERecNumberFilter.MemoryIndexIter = Dem_Memory_MemEntry_IterGetMemoryIndex(&lPrimaryEventEntryIter);                           /* SBSW_DEM_CALL_ITERATOR_POINTER */
  Dem_Dcm_ERec_0x1916_SetRecordNumberFilter(ExtendedDataFilterId, &lERecNumberFilter);                                           /* SBSW_DEM_POINTER_FORWARD_STACK */
  return lReturnValue;
}                                                                                                                                /* PRQA S 6050, 6080 */ /* MD_MSR_STCAL, MD_MSR_STMIF */
...
)
{
  ...
  Dem_Dcm_ERec_0x1916_DataCollectionERecIterType lExtendedEntryIter;
  lIndexFound = FALSE;

  /* Find the requested record */
  for (Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Init(&lExtendedEntryIter);                                                     /* SBSW_DEM_CALL_ITERATOR_POINTER */
    Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Exists(&lExtendedEntryIter) == TRUE;                                              /* PRQA S 2994 */ /* MD_DEM_2994 */ /* SBSW_DEM_CALL_ITERATOR_POINTER */
    Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Next(&lExtendedEntryIter))                                                        /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    lDataCollectionIndex = Dem_Dcm_ERec_0x1916_DataCollectionERecIter_Get(&lExtendedEntryIter);                                  /* SBSW_DEM_CALL_ITERATOR_POINTER */
...
)
{
  ...
  Dem_Dcm_ERec_0x1916_GlobalERecIter_Invalidate(&(lTempRecordFilter.GlobalERecIterator));                                        /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */

  lTempRecordFilter.MemoryIndexIter = DEM_MEM_INVALID_MEMORY_INDEX;
...
)
{
  ...
  lERecFound = Dem_Dcm_ERec_0x1916_FindDataCollectionTableIndexByRecordnumber(RecordNumber, &lDataCollectionTableIndex);         /* SBSW_DEM_POINTER_FORWARD_STACK */
