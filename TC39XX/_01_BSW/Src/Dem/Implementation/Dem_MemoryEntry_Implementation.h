...
#define DEM_MEMORYENTRY_IMPLEMENTATION_FILENAME "Dem_MemoryEntry_Implementation.h"
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  ...
  {
    Dem_Error_RunTimeCheckFailed(DEM_MEMORYENTRY_IMPLEMENTATION_FILENAME, __LINE__);                                             /* SBSW_DEM_POINTER_RUNTIME_CHECK */
    lMemoryEntry = Dem_Cfg_GetMemoryEntry(0);                                                                                    /* PRQA S 0310, 3305 */ /* MD_DEM_11.4_nvm, MD_DEM_3305 */
  }
  else
# endif
  {
    lMemoryEntry = Dem_Cfg_GetMemoryEntry(MemoryEntryId);                                                                        /* PRQA S 0310, 3305, 2842 */ /* MD_DEM_11.4_nvm, MD_DEM_3305, MD_DEM_Dir4.1_MemoryEntryPointerAccess */
  }
