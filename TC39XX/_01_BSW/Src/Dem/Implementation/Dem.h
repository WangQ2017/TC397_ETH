 ...
 *            2020-07-15  visern       ESCAN00106517 IUMPR Numerator and Denominator are not incremented correctly
...
#define DEM_SW_MAJOR_VERSION                     (19U)
#define DEM_SW_MINOR_VERSION                     (7U)
...
#define DEM_GETNUMBEROFFILTEREDEXTENDEDDATARECORDS        (0xe1U)              /*< Service ID: Dem_GetNumberOfFilteredExtendedDataRecords() */   
#define DEM_GETNEXTFILTEREDEXTENDEDDATARECORD             (0xe2U)              /*< Service ID: Dem_GetNextFilteredExtendedDataRecord() */   
