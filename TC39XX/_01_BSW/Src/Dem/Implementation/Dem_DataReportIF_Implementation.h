...
#define DEM_DATAREPORTIF_IMPLEMENTATION_FILENAME "Dem_DataReportIF_Implementation.h"
  ...
  )
{
  ...
  Dem_Data_WriteDestinationBuffer(CopyDidInfoPtr->DestinationBuffer,                                                             /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                 &CopyDidInfoPtr->SourceBuffer[CopyDidInfoPtr->ReadIndex],                                       /* PRQA S 2821 */ /* MD_DEM_Dir4.1_ReadOperation */
                                  lDataSize);
  ...
  )
{
    ...
    Dem_Cfg_DidDataIterNext(&lDataIter))                                                                                         /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    if (Dem_Cfg_DataIsStoredInNV(lDataIndex) == TRUE)
    {
      lReturnValue = Dem_DataReportIF_CopyStoredDataElement(CopyDidInfoPtr, lDataIndex) && lReturnValue;                         /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    }
    else
    {
      lReturnValue = Dem_ExtDataElementIF_CollectDataElement(CopyDidInfoPtr, lDataIndex) && lReturnValue;                        /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    }
  }
  ...
  )
{
    ...
    Dem_Cfg_DidDataIterNext(&lDataIter))                                                                                         /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    if (Dem_Cfg_DataIsStoredInNV(lDataIndex) == TRUE)
    {
      ...
      case DEM_CFG_DATA_FROM_SR_PORT_SINT8_N:
      case DEM_CFG_DATA_FROM_SR_PORT_UINT8_N:
        if (Dem_DataReportIF_CopyStoredUserData(CopyDidInfoPtr, lDataIndex) == FALSE)                                            /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
        {
          lReturnValue = FALSE;                
        }
        break;
      ...
      default:
        if (Dem_DataReportIF_CopyReplacementBytes(CopyDidInfoPtr->DestinationBuffer, lDataIndex) == FALSE)                       /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
        {
          lReturnValue = FALSE;
        }
        break;
    ...
    {
      if (Dem_ExtDataElementIF_CollectDataElement(CopyDidInfoPtr, lDataIndex) == FALSE)                                          /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
      {
        lReturnValue = FALSE;
      }
    }
  ...
  )
{
  ...
  CopyDidInfoPtr->ReadIndex = 0u;                                                                                                /* SBSW_DEM_CALL_COPYDIDINFO_INIT */
  ...
  CopyDidInfoPtr->MemIndeCounterPtr = MemIndeCounterPtr;                                                                         /* SBSW_DEM_CALL_COPYDIDINFO_INIT */
#else
  CopyDidInfoPtr->MemIndeCounterPtr = NULL_PTR;                                                                                  /* SBSW_DEM_CALL_COPYDIDINFO_INIT */
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(MemIndeCounterPtr)                                                                            /* PRQA S 3112 */ /* MD_DEM_14.2 */
#endif

}                                                                                                                                /* PRQA S 6060 */ /* MD_DEM_6060_COPYDIDINFO */
#endif
/*!
 * \}
 */
...
)
{
  ...
  if (Dem_Data_IncrementWriteIndexDestinationBuffer(DestinationBuffer, 1) == E_OK)                                               /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  {
    ...
    Dem_DataReportIF_InitCopyDidInfo(&lCopyDidInfo, DestinationBuffer, SourceBuffer, EventId , MemoryEntryId, MemIndeCounterPtr);/* SBSW_DEM_CALL_COPYDIDINFO_INIT */
  ...
  )
{
  if (DestinationBuffer->BufferSize > DestinationBuffer->WriteIndex)
  {
    ...
    Dem_DataReportIF_InitCopyDidInfo(&lCopyDidInfo, DestinationBuffer, SourceBuffer, lEventId, MemoryEntryId, MemIndeCounterPtr); /* SBSW_DEM_CALL_COPYDIDINFO_INIT */
...
Dem_DataReportIF_CopyExtendedDataRecord(
  ...
  CONST(Dem_Cfg_ReadoutMemIndeCounterPtrType, AUTOMATIC) MemIndeCounterPtr                                                       /* PRQA S 3673 */ /* MD_DEM_8.13_fp */
  )
{
  Std_ReturnType lReturnValue;
...
# endif
  ...
  Dem_DataReportIF_InitCopyDidInfo(&lCopyDidInfo, DestinationBuffer, lSourceBuffer, EventId, MemoryEntryId, MemIndeCounterPtr);  /* SBSW_DEM_CALL_COPYDIDINFO_INIT */
  ...
  return lReturnValue;
}                                                                                                                                /* PRQA S 6050, 6060 */ /* MD_MSR_STCAL, MD_DEM_6060_COPYDIDINFO */
