...
struct Dem_DataReportIF_CopyDidInfoType_s
{
  ...
  Dem_Cfg_ReadoutMemIndeCounterPtrType       MemIndeCounterPtr;  /*< Pointer to readout buffer copy of the event memory indepedent
                                                                counter for Dcm requests or NULL_PTR for Swc requests*/
};
