...
# define OS_SW_MINOR_VERSION                     (57u)
 ...
 *
 *  \return       Current stack usage of the given task in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *
 *  \return       Current stack usage of the given ISR in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *
 *  \return       Current kernel stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *  \param[in]    CoreID         The core which shall be queried.
 *
 *  \return       Current startup hook stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *  \param[in]    CoreID         The core which shall be queried.
 *
 *  \return       Current error hook stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *  \param[in]    CoreID         The core which shall be queried.
 *
 *  \return       Current shutdown hook stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *  \param[in]    CoreID         The core which shall be queried.
 *
 *  \return       Current protection hook stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *
 *  \return       Current stack usage of the given non-trusted function in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
