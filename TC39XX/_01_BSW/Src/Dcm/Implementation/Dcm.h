 ...
 *  Wilfried Steudle              viswse        Vector Informatik GmbH
 *  Philipp Steinle               visepp        Vector Informatik GmbH
 *  Bashar Dawood                 vsarcbada     Vector Informatik GmbH
 *  Zisis Adamos                  vsarcziad     Vector Informatik GmbH
 *  Afshin Rostami                vsarcafro     Vector Informatik GmbH
 *  Esha Tandon                   vsarcesta     Vector Informatik GmbH
 *  -------------------------------------------------------------------------------------------------------------------
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
...
/* ----------------------------------------------
 ~&&&   Versions
---------------------------------------------- */
# define DIAG_ASR4DCM_VERSION                                        0x1405u
...
# define DCM_SW_MAJOR_VERSION                                        14u
