...
#if ((LDCOM_SW_MAJOR_VERSION != 3u) || (LDCOM_SW_MINOR_VERSION != 1u) || (LDCOM_SW_PATCH_VERSION != 0u))
...
#if (LDCOM_USE_INIT_POINTER == STD_ON)
P2CONST(LdCom_ConfigType, LDCOM_VAR_ZERO_INIT, LDCOM_PBCFG) LdCom_ConfigDataPtr = NULL_PTR;     /* PRQA S 1504 */ /* MD_MSR_Rule8.7 */
#endif
...
# endif
  ...
  {
    /* ----- Implementation ----------------------------------------------- */
    LdCom_SetInitialized(TRUE);        /* SBSW_LDCOM_CSL_VAR_ACCESS */
  }
...
{
  LdCom_SetInitialized(FALSE);        /* SBSW_LDCOM_CSL_VAR_ACCESS */
#if(LDCOM_USE_INIT_POINTER == STD_ON)
  LdCom_ConfigDataPtr = NULL_PTR;
#endif
}
...
#endif
  LDCOM_DUMMY_STATEMENT(errorId);       /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(Id);            /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(PduInfoPtr);    /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  return retVal;
}
...
#  endif
  ...
  else if(LdCom_IsTxPduOfRxTxPduInfo(RxPduId))   /* COV_LDCOM_FEATURE_ALWAYS_FALSE */ 
  {
    errorId = LDCOM_E_INVALID_PDU_SDU_ID;
  }
  /* Check if the handle Id refers to an If Pdu */
  else if(!LdCom_IsIfPduOfRxTxPduInfo(RxPduId))  /* COV_LDCOM_FEATURE_ALWAYS_FALSE */
  {
    errorId = LDCOM_E_INVALID_PDU_SDU_ID;
  }
  else
...
# if (LDCOM_IFRXINDICATIONFCTPTRUSEDOFRXTXPDUINFO == STD_ON)
    if(LdCom_IsIfRxIndicationFctPtrUsedOfRxTxPduInfo(RxPduId))  
    {
...
# endif
  LDCOM_DUMMY_STATEMENT(errorId);       /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(RxPduId);       /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(PduInfoPtr);    /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
...
#   endif
  ...
  else if(!LdCom_IsTxPduOfRxTxPduInfo(TxPduId)) /* COV_LDCOM_FEATURE_ALWAYS_FALSE */ 
  {
    errorId = LDCOM_E_INVALID_PDU_SDU_ID;
  }
  /* Check if the handle Id refers to an If Pdu */
  else if(!LdCom_IsIfPduOfRxTxPduInfo(TxPduId)) /* COV_LDCOM_FEATURE_ALWAYS_FALSE */
  {
    errorId = LDCOM_E_INVALID_PDU_SDU_ID;
  }
  else
...
#  endif
  LDCOM_DUMMY_STATEMENT(errorId);       /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(TxPduId);       /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
}      /* PRQA S 6080 */ /* MD_MSR_STMIF */
# endif
...
#  endif
  /* Check if the handle Id refers to a Rx Pdu */
  else if(LdCom_IsTxPduOfRxTxPduInfo(id))       /* COV_LDCOM_FEATURE_ALWAYS_FALSE */
  {
    errorId = LDCOM_E_INVALID_PDU_SDU_ID;
  }
  /* Check if the handle Id refers to an Tp Pdu */
  else if(LdCom_IsIfPduOfRxTxPduInfo(id))       /* COV_LDCOM_FEATURE_ALWAYS_FALSE */ 
  {
    errorId = LDCOM_E_INVALID_PDU_SDU_ID;
  }
  else
...
# endif
  LDCOM_DUMMY_STATEMENT(errorId);      /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(id);           /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(info);         /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(TpSduLength);  /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(bufferSizePtr);/* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  return retVal;
}     /* PRQA S 6080 */ /* MD_MSR_STMIF */
...
# endif
  LDCOM_DUMMY_STATEMENT(errorId);       /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(id);            /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(result);        /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
}   /* PRQA S 6080 */ /* MD_MSR_STMIF */
...
# endif
  ...
  LDCOM_DUMMY_STATEMENT(id);                    /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(info);                  /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(retry);                 /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  LDCOM_DUMMY_STATEMENT(availableDataPtr);      /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  return retVal;
}     /* PRQA S 6080 */ /* MD_MSR_STMIF */
