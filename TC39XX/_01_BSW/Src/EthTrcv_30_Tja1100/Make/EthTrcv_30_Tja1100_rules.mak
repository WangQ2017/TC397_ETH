...
#------------------------------------------------------------------------------
# 1.00.00   2017-03-14  visdrr  Initial creation
# 3.00.00   2018-01-19  visdrr  Adapted for new architecture
...
EthTrcv_30_Tja1100_FILES        = EthTrcv_30_Tja1100$(BSW_SRC_DIR)\EthTrcv_30_Tja1100.c EthTrcv_30_Tja1100$(BSW_SRC_DIR)\EthTrcv_30_Tja1100_Wakeup.c EthTrcv_30_Tja1100$(BSW_SRC_DIR)\EthTrcv_30_Tja1100_Hw.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += EthTrcv_30_Tja1100$(BSW_SRC_DIR)\EthTrcv_30_Tja1100.c EthTrcv_30_Tja1100$(BSW_SRC_DIR)\EthTrcv_30_Tja1100_Wakeup.c EthTrcv_30_Tja1100$(BSW_SRC_DIR)\EthTrcv_30_Tja1100_Hw.c
endif
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\EthTrcv_30_Tja1100*.c
