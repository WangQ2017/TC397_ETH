 ...
 *  Bernhard Karl                 Bka           Vector Informatik GmbH
 *  Emanuel Nowak                 Eno           Vector Informatik GmbH
 *  Leon Jonas                    Ljs           Vector Informatik GmbH
 *  Andreas Lackner               Lra           Vector Informatik GmbH
 *  -------------------------------------------------------------------------------------------------------------------
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
...
#define NVM_SW_MAJOR_VERSION       (7u)
