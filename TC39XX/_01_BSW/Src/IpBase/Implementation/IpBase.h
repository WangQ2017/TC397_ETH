 ...
 *  Dominik Bauer                 visbdk        Vector Informatik GmbH
 *  -------------------------------------------------------------------------------------------------------------------
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
...
# define IPBASE_SW_PATCH_VERSION                    (7u)
...
# define IPBASE_API_SID_CALC_TCPIP_CHCECKSUM           (0x65u) /*!< Service ID: IpBase_CalcTcpIpChecksum() */
# define IPBASE_API_SID_CALC_TCPIP_CHCECKSUM2          (0x66u) /*!< Service ID: IpBase_CalcTcpIpChecksum2() */
# define IPBASE_API_SID_CALC_TCPIP_CHCECKSUMADD        (0x67u) /*!< Service ID: IpBase_TcpIpCheckumAdd() */
