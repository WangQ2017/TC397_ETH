 ...
 *********************************************************************************************************************/
  ...
  ComM_StateType ComMChannel_Vlan23 = COMM_NO_COM_NO_PENDING_REQUEST;
  ...
  (void)ComM_GetState(ComMConf_ComMChannel_ComMChannel_Vlan23, &ComMChannel_Vlan23); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  
  if((ComMChannel_untagged != COMM_NO_COM_NO_PENDING_REQUEST) || (ComMChannel_Vlan1 != COMM_NO_COM_NO_PENDING_REQUEST) || (ComMChannel_Vlan23 != COMM_NO_COM_NO_PENDING_REQUEST))
  {
