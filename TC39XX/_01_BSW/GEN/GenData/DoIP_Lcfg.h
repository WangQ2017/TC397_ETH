...
#define DoIP_GetTcpIpLocalAddrIdOfLocalAddr(Index)                                                  ((DoIP_TcpIpLocalAddrIdOfLocalAddrType)((((DoIP_TcpIpLocalAddrIdOfLocalAddrType)(Index)) + 2u)))  /**< the TcpIp local address id */
...
{
  DoIP_DiagNAckBufType DoIPTester_x0E80[256];
...
{
  DoIP_TesterDynType DoIPTester_x0E80;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(DoIP_EIdType, DOIP_CONST) DoIP_EId[6];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(DoIP_TxUdpMgtListType, DOIP_VAR_NOINIT) DoIP_TxUdpMgtList[2];
#define DOIP_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
