...
{
  EthTSyn_SystemStateType EthTSynGlobalTimeDomain_MAIN0;
  EthTSyn_SystemStateType EthTSynGlobalTimeDomain_MAIN6;
...
{
  EthTSyn_TimeBaseUpdateCounterType EthTSynGlobalTimeDomain_MAIN0;
  EthTSyn_TimeBaseUpdateCounterType EthTSynGlobalTimeDomain_MAIN6;
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  EthTSyn_TimeBaseUpdateCounterType raw[2];
