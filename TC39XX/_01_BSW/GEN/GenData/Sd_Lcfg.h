 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Sd_Lcfg.h
 *   Generation Time: 2026-07-11 17:22:49
...
typedef uint16 Sd_OfferCyclicDelayOfServerTimerType;
...
typedef struct Sd_MulticastEndpointAddrStructSTag
{
  ...
  Sd_SockAddrContainerType SdConsumedEventGroup_0xC3CC_VechicleStatus;
...
typedef struct Sd_RoutingGroupDynStructSTag
{
  ...
  Sd_RoutingGroupDynType SoAdRoutingGroup_VechicleStatus_AM;
