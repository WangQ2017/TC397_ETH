 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: PduR_Lcfg.c
 *   Generation Time: 2026-05-30 23:55:05
...
CONST(PduR_MmRomType, PDUR_CONST) PduR_MmRom[3] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */                           0u,      0x01u, PDUR_NO_RMGDESTROMENDIDXOFMMROM, PDUR_NO_RMGDESTROMSTARTIDXOFMMROM, Com_RxIndication      , NULL_PTR                , NULL_PTR           },  /* [BswModule: Com]   */  /* [/ActiveEcuC/PduR/Com, /ActiveEcuC/PduR] */
  { /*     1 */                           0u,      0x01u, PDUR_NO_RMGDESTROMENDIDXOFMMROM, PDUR_NO_RMGDESTROMSTARTIDXOFMMROM, LdCom_RxIndication    , LdCom_TxConfirmation    , NULL_PTR           },  /* [BswModule: LdCom] */  /* [/ActiveEcuC/PduR/LdCom, /ActiveEcuC/PduR] */
  { /*     2 */                           0u,      0x06u,                              2u,                                0u, NULL_PTR              , NULL_PTR                , SoAd_IfTransmit    }   /* [BswModule: SoAd]  */  /* [/ActiveEcuC/PduR/SoAd, /ActiveEcuC/PduR] */
};
#define PDUR_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "PduR_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(PduR_RmDestRomType, PDUR_CONST) PduR_RmDestRom[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */ PDUR_IGNORE_PDULENGTHHANDLINGSTRATEGYOFRMDESTROM },  /* [PduRDestPdu: PduRDestPdu_TxPdu_SoAd]     */  /* [/ActiveEcuC/PduR/PduRRoutingTables/PduRRoutingTable/PduRRoutingPath_TimeSyncStatus_Tx/PduRSrcPdu, /ActiveEcuC/PduR/PduRRoutingTables/PduRRoutingTable/PduRRoutingPath_TimeSyncStatus_Tx/PduRDestPdu_TxPdu_SoAd] */
  { /*     1 */ PDUR_IGNORE_PDULENGTHHANDLINGSTRATEGYOFRMDESTROM }   /* [PduRDestPdu: PduRDestPdu_udplog_Tx_SoAd] */  /* [/ActiveEcuC/PduR/PduRRoutingTables/PduRRoutingTable/PduRRoutingPath_udplog_Tx/PduRSrcPdu_udplog_Tx_LdCom, /ActiveEcuC/PduR/PduRRoutingTables/PduRRoutingTable/PduRRoutingPath_udplog_Tx/PduRDestPdu_udplog_Tx_SoAd] */
};
#define PDUR_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "PduR_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(PduR_RmGDestRomType, PDUR_CONST) PduR_RmGDestRom[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    MaxPduLength  PartitionIndexOfCsl                            PduRDestPduProcessing                                   Comment                                                     Referable Keys */
  { /*     0 */           1u,                  0u  /* CommonSharedMemory */, PDUR_IMMEDIATE_PDURDESTPDUPROCESSINGOFRMGDESTROM },  /* [Global PduRDestPdu: TimeSyncStatus_TxPdu_SoAd] */  /* [/ActiveEcuC/EcuC/EcucPduCollection/TimeSyncStatus_TxPdu_SoAd, /ActiveEcuC/PduR/SoAd] */
  { /*     1 */        1500u,                  0u  /* CommonSharedMemory */, PDUR_IMMEDIATE_PDURDESTPDUPROCESSINGOFRMGDESTROM }   /* [Global PduRDestPdu: udplog_TxPdu_SoAd]         */  /* [/ActiveEcuC/EcuC/EcucPduCollection/udplog_TxPdu_SoAd, /ActiveEcuC/PduR/SoAd] */
};
#define PDUR_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "PduR_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(PduR_RmSrcRomType, PDUR_CONST) PduR_RmSrcRom[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    PartitionIndexOfCsl                            SrcHnd                                         Comment                                              Referable Keys */
  { /*     0 */                  0u  /* CommonSharedMemory */,                PDUR_NO_SRCHNDOFRMSRCROM },  /* [PduRSrcPdu: PduRSrcPdu]                 */  /* [/ActiveEcuC/PduR/PduRRoutingTables/PduRRoutingTable/PduRRoutingPath_TimeSyncStatus_Tx/PduRSrcPdu] */
  { /*     1 */                  0u  /* CommonSharedMemory */, LdComConf_LdComIPdu_LdComIPdu_udplog_Tx }   /* [PduRSrcPdu: PduRSrcPdu_udplog_Tx_LdCom] */  /* [/ActiveEcuC/PduR/PduRRoutingTables/PduRRoutingTable/PduRRoutingPath_udplog_Tx/PduRSrcPdu_udplog_Tx_LdCom] */
};
#define PDUR_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "PduR_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(PduR_Tx2LoType, PDUR_CONST) PduR_Tx2Lo[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */                  0u },  /* [/ActiveEcuC/PduR/PduRRoutingTables/PduRRoutingTable/PduRRoutingPath_TimeSyncStatus_Tx/PduRSrcPdu] */
  { /*     1 */                  0u }   /* [/ActiveEcuC/PduR/PduRRoutingTables/PduRRoutingTable/PduRRoutingPath_udplog_Tx/PduRSrcPdu_udplog_Tx_LdCom] */
};
#define PDUR_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "PduR_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
