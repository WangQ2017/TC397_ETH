...
/*! Dynamic alarm data: Rte_Al_TE2_OsTask_Bsw_OsCore0_0_10ms */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_OsCore0_0_10ms_Dyn;
...
/*! Alarm configuration data: Rte_Al_TE2_OsTask_Bsw_OsCore0_0_10ms */
CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_OsCore0_0_10ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_OsCore0_0_10ms_Dyn),
  ...
  /* .Task  = */ &OsCfg_Task_OsTask_Bsw_OsCore0
};
...
CONSTP2CONST(Os_AlarmConfigType, OS_CONST, OS_CONST) OsCfg_AlarmRefs[OS_ALARMID_COUNT + 1] =  /* PRQA S 4521 */ /* MD_Os_Rule10.1_4521 */
{
  ...
  OS_ALARM_CASTCONFIG_ALARMACTIVATETASK_2_ALARM(OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_OsCore0_0_10ms),
