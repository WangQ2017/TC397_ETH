 ...
 *   Generation Time: 2026-07-11 19:56:11
...
/*! Dynamic alarm data: Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_10ms */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_10ms_Dyn;

/*! Dynamic alarm data: Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_20ms */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_20ms_Dyn;
...
/*! Dynamic alarm data: Rte_Al_TE_Cdd_Core0_Cdd_Core0_Runnable20ms */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE_Cdd_Core0_Cdd_Core0_Runnable20ms_Dyn;
...
/*! Dynamic alarm data: Rte_Al_TE_EthTrcv_30_Tja1100_EthTrcv_30_Tja1100_MainFunction */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE_EthTrcv_30_Tja1100_EthTrcv_30_Tja1100_MainFunction_Dyn;

/*! Dynamic alarm data: Rte_Al_TE_OsTask_Asw_OsCore0_0_100ms */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE_OsTask_Asw_OsCore0_0_100ms_Dyn;

/*! Dynamic alarm data: Rte_Al_TE_OsTask_Asw_OsCore0_0_10ms */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE_OsTask_Asw_OsCore0_0_10ms_Dyn;
...
CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_10ms_Core0_0_10ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
...
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_10ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_10ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERHRT_2_COUNTER(OsCfg_Counter_SystemTimer_OsCore0),
  ...
  /* .Mask  = */ Rte_Ev_Cyclic2_OsTask_Bsw_5ms_Core0_0_10ms
};


/*! Alarm configuration data: Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_20ms */
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_20ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_20ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERHRT_2_COUNTER(OsCfg_Counter_SystemTimer_OsCore0),
      /* .Callback = */ Os_AlarmActionSetEvent
    },
    /* .Autostart             = */
  ...
  /* .Task  = */ &OsCfg_Task_OsTask_Bsw_5ms_Core0,
  /* .Mask  = */ Rte_Ev_Cyclic2_OsTask_Bsw_5ms_Core0_0_20ms
};


/*! Alarm configuration data: Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_5ms */
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_5ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
  ...
  /* .Task  = */ &OsCfg_Task_OsTask_Bsw_5ms_Core0,
  /* .Mask  = */ Rte_Ev_Cyclic2_OsTask_Bsw_5ms_Core0_0_5ms
};
...
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_Cdd_Core0_Cdd_Core0_Runnable1ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE_Cdd_Core0_Cdd_Core0_Runnable1ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERHRT_2_COUNTER(OsCfg_Counter_SystemTimer_OsCore0),
      /* .Callback = */ Os_AlarmActionSetEvent
    },
    /* .Autostart             = */
  ...
  /* .Mask  = */ Rte_Ev_Run_Cdd_Core0_Cdd_Core0_Runnable1ms
};


/*! Alarm configuration data: Rte_Al_TE_Cdd_Core0_Cdd_Core0_Runnable20ms */
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_Cdd_Core0_Cdd_Core0_Runnable20ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE_Cdd_Core0_Cdd_Core0_Runnable20ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERHRT_2_COUNTER(OsCfg_Counter_SystemTimer_OsCore0),
      /* .Callback = */ Os_AlarmActionSetEvent
    },
    /* .Autostart             = */
  ...
  /* .Task  = */ &OsCfg_Task_OsTask_Asw_OsCore0,
  /* .Mask  = */ Rte_Ev_Run_Cdd_Core0_Cdd_Core0_Runnable20ms
};
...
CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_EthTrcv_30_Tja1100_EthTrcv_30_Tja1100_MainFunction =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE_EthTrcv_30_Tja1100_EthTrcv_30_Tja1100_MainFunction_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERHRT_2_COUNTER(OsCfg_Counter_SystemTimer_OsCore0),
      /* .Callback = */ Os_AlarmActionActivateTask
    },
    /* .Autostart             = */
...
/*! Alarm configuration data: Rte_Al_TE_OsTask_Asw_OsCore0_0_100ms */
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_OsTask_Asw_OsCore0_0_100ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE_OsTask_Asw_OsCore0_0_100ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERHRT_2_COUNTER(OsCfg_Counter_SystemTimer_OsCore0),
      /* .Callback = */ Os_AlarmActionSetEvent
    },
    /* .Autostart             = */
  ...
  /* .Task  = */ &OsCfg_Task_OsTask_Asw_OsCore0,
  /* .Mask  = */ Rte_Ev_Cyclic_OsTask_Asw_OsCore0_0_100ms
};


/*! Alarm configuration data: Rte_Al_TE_OsTask_Asw_OsCore0_0_10ms */
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_OsTask_Asw_OsCore0_0_10ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE_OsTask_Asw_OsCore0_0_10ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERHRT_2_COUNTER(OsCfg_Counter_SystemTimer_OsCore0),
      /* .Callback = */ Os_AlarmActionSetEvent
    },
    /* .Autostart             = */
  ...
  /* .Task  = */ &OsCfg_Task_OsTask_Asw_OsCore0,
  /* .Mask  = */ Rte_Ev_Cyclic_OsTask_Asw_OsCore0_0_10ms
};


/*! Alarm configuration data: Rte_Al_TE_OsTask_Asw_OsCore0_0_5ms */
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_OsTask_Asw_OsCore0_0_5ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE_OsTask_Asw_OsCore0_0_5ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERHRT_2_COUNTER(OsCfg_Counter_SystemTimer_OsCore0),
      /* .Callback = */ Os_AlarmActionSetEvent
    },
    /* .Autostart             = */
...
CONSTP2CONST(Os_AlarmConfigType, OS_CONST, OS_CONST) OsCfg_AlarmRefs[OS_ALARMID_COUNT + 1] =  /* PRQA S 4521 */ /* MD_Os_Rule10.1_4521 */
{
  ...
  OS_ALARM_CASTCONFIG_ALARMSETEVENT_2_ALARM(OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_10ms),
  OS_ALARM_CASTCONFIG_ALARMSETEVENT_2_ALARM(OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_5ms_Core0_0_20ms),
  ...
  OS_ALARM_CASTCONFIG_ALARMSETEVENT_2_ALARM(OsCfg_Alarm_Rte_Al_TE_Cdd_Core0_Cdd_Core0_Runnable1ms),
  OS_ALARM_CASTCONFIG_ALARMSETEVENT_2_ALARM(OsCfg_Alarm_Rte_Al_TE_Cdd_Core0_Cdd_Core0_Runnable20ms),
  ...
  OS_ALARM_CASTCONFIG_ALARMACTIVATETASK_2_ALARM(OsCfg_Alarm_Rte_Al_TE_EthTrcv_30_Tja1100_EthTrcv_30_Tja1100_MainFunction),
  OS_ALARM_CASTCONFIG_ALARMSETEVENT_2_ALARM(OsCfg_Alarm_Rte_Al_TE_OsTask_Asw_OsCore0_0_100ms),
