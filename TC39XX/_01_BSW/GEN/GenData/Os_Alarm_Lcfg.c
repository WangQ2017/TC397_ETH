...
/*! Dynamic alarm data: Rte_Al_TE2_OsTask_Bsw_20ms_Core0_0_20ms */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_20ms_Core0_0_20ms_Dyn;
...
/*! Alarm configuration data: Rte_Al_TE2_OsTask_Bsw_20ms_Core0_0_20ms */
CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_20ms_Core0_0_20ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE2_OsTask_Bsw_20ms_Core0_0_20ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERHRT_2_COUNTER(OsCfg_Counter_SystemTimer_OsCore0),
      /* .Callback = */ Os_AlarmActionActivateTask
    },
    /* .Autostart             = */
...
CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_EthTrcv_30_Tja1100_EthTrcv_30_Tja1100_MainFunctionLinkHandling =
{
  /* .Alarm = */
  {
    /* .Job                   = */
