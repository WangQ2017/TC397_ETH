...
extern CONST(Os_HookInitHookConfigType, OS_CONST) OsCfg_Hook_Os_CoreInitHook_OsCore3;

/*! Hook configuration data: StartupHook_OsCore3 */
extern CONST(Os_HookCallbackConfigType, OS_CONST) OsCfg_Hook_StartupHook_OsCore3;

/*! Hook configuration data: ShutdownHook_OsCore3 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ShutdownHook_OsCore3;

/*! Hook configuration data: ErrorHook_OsCore3 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ErrorHook_OsCore3;
...
extern CONST(Os_HookInitHookConfigType, OS_CONST) OsCfg_Hook_Os_CoreInitHook_OsCore4;

/*! Hook configuration data: StartupHook_OsCore4 */
extern CONST(Os_HookCallbackConfigType, OS_CONST) OsCfg_Hook_StartupHook_OsCore4;

/*! Hook configuration data: ShutdownHook_OsCore4 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ShutdownHook_OsCore4;

/*! Hook configuration data: ErrorHook_OsCore4 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ErrorHook_OsCore4;
...
extern CONST(Os_HookInitHookConfigType, OS_CONST) OsCfg_Hook_Os_CoreInitHook_OsCore5;

/*! Hook configuration data: StartupHook_OsCore5 */
extern CONST(Os_HookCallbackConfigType, OS_CONST) OsCfg_Hook_StartupHook_OsCore5;

/*! Hook configuration data: ShutdownHook_OsCore5 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ShutdownHook_OsCore5;

/*! Hook configuration data: ErrorHook_OsCore5 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ErrorHook_OsCore5;
