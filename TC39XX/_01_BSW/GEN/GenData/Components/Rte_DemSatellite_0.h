...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemSatellite_0_CBReadData_Data_Did_0x16E_MCU_Info_ReadData(P2VAR(uint8, AUTOMATIC, RTE_DEMSATELLITE_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# else
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemSatellite_0_CBReadData_Data_Did_0x16E_MCU_Info_ReadData(P2VAR(DataArrayType_uint8_8, AUTOMATIC, RTE_DEMSATELLITE_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# endif
 ...
 *********************************************************************************************************************/
#  define Rte_Call_CBReadData_Data_Did_0x16E_MCU_Info_ReadData Rte_Call_DemSatellite_0_CBReadData_Data_Did_0x16E_MCU_Info_ReadData
