...
#  define Rte_InitValue_Request_SDC_C_SdCLientService_0xC3CB_VechicleSpeed_requestedMode (0U)
#  define Rte_InitValue_Request_SDC_C_SdCLientService_0xC3CB_VechicleSpeed_CEG_SdConsumedEventGroup_0xC3CB_VechicleSpeed_requestedMode (0U)
#  define Rte_InitValue_Request_SDC_C_SdCLientService_0xC3CD_VechicleInfo_requestedMode (0U)
#  define Rte_InitValue_Request_SDC_C_SdCLientService_0xC3CD_VechicleInfo_CEG_SdConsumedEventGroup_0xC3CD_VechicleInfo_requestedMode (0U)
#  define Rte_InitValue_Request_SDC_C_SdClientService_0xC3CC_VechicleStatus_requestedMode (0U)
#  define Rte_InitValue_Request_SDC_C_SdClientService_0xC3CC_VechicleStatus_CEG_SdConsumedEventGroup_0xC3CC_VechicleStatus_requestedMode (0U)
#  define Rte_InitValue_Request_SDC_S_SdServerService_0xC3C0_FaultInfo_requestedMode (0U)
#  define Rte_InitValue_Request_SDC_S_SdServerService_0xC3C1_SenState_requestedMode (0U)
#  define Rte_InitValue_Request_SDC_S_SdServerService_0xC3C2_EcuState_requestedMode (0U)
# endif
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_BswM_Switch_SDC_Mode_S_SdServerService_0xC3C2_EcuState_EH_SdEventHandler_0xC3C1_EcuState_BswM_MDGP_SDC_SdEventHandlerState(BswM_SDC_SdEventHandlerState nextMode);
...
#  define Rte_Switch_Switch_SDC_Mode_S_SdServerService_0xC3C2_EcuState_EH_SdEventHandler_0xC3C1_EcuState_BswM_MDGP_SDC_SdEventHandlerState Rte_Switch_BswM_Switch_SDC_Mode_S_SdServerService_0xC3C2_EcuState_EH_SdEventHandler_0xC3C1_EcuState_BswM_MDGP_SDC_SdEventHandlerState
