 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemMaster_0_CBFaultDetectCtr_DTC_0xDDD094_Event_GetFaultDetectionCounter(P2VAR(sint8, AUTOMATIC, RTE_DEMMASTER_0_APPL_VAR) FaultDetectionCounter); /* PRQA S 3451, 0786, 3449, 0624 */ /* MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
 ...
 *********************************************************************************************************************/
#  define Rte_Call_CBFaultDetectCtr_DTC_0xDDD094_Event_GetFaultDetectionCounter Rte_Call_DemMaster_0_CBFaultDetectCtr_DTC_0xDDD094_Event_GetFaultDetectionCounter
#  define RTE_START_SEC_CDD_UDS_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
#  ifdef RTE_PTR2ARRAYBASETYPE_PASSING
FUNC(Std_ReturnType, RTE_CDD_UDS_APPL_CODE) CSDataServices_Data_Did_0x16E_MCU_Info_ReadData(P2VAR(uint8, AUTOMATIC, RTE_CDD_UDS_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
#  else
FUNC(Std_ReturnType, RTE_CDD_UDS_APPL_CODE) CSDataServices_Data_Did_0x16E_MCU_Info_ReadData(P2VAR(DataArrayType_uint8_8, AUTOMATIC, RTE_CDD_UDS_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
#  endif
#  define RTE_STOP_SEC_CDD_UDS_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */

#  define Rte_Call_CBReadData_Data_Did_0x16E_MCU_Info_ReadData CSDataServices_Data_Did_0x16E_MCU_Info_ReadData
