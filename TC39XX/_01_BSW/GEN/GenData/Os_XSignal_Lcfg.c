...
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore0_Send2_XSignalIsr_OsCore3_Recv0_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore0_Send2_Data[OS_CFG_SIZE_OSCORE0_SEND2_XSIGNALISR_OSCORE3_RECV0_BUFFER];

/* Dynamic X-Signal send port data: OsCore0 -> OsCore5/XSignalIsr_OsCore5_Recv0 */
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore0_Send3_XSignalIsr_OsCore5_Recv0_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore0_Send3_Data[OS_CFG_SIZE_OSCORE0_SEND3_XSIGNALISR_OSCORE5_RECV0_BUFFER];

/* Dynamic X-Signal send port data: OsCore0 -> OsCore1/XSignalIsr_OsCore1_Recv0 */
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore0_Send4_XSignalIsr_OsCore1_Recv0_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore0_Send4_Data[OS_CFG_SIZE_OSCORE0_SEND4_XSIGNALISR_OSCORE1_RECV0_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore0_Recv0 <- OsCore1 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore1_Send4_XSignalIsr_OsCore0_Recv0_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore0_Recv0_Data[OS_CFG_SIZE_OSCORE1_SEND4_XSIGNALISR_OSCORE0_RECV0_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore5_Send3_XSignalIsr_OsCore0_Recv4_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore0_Recv4_Data[OS_CFG_SIZE_OSCORE5_SEND3_XSIGNALISR_OSCORE0_RECV4_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore1_Send2_XSignalIsr_OsCore3_Recv1_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore1_Send2_Data[OS_CFG_SIZE_OSCORE1_SEND2_XSIGNALISR_OSCORE3_RECV1_BUFFER];

/* Dynamic X-Signal send port data: OsCore1 -> OsCore5/XSignalIsr_OsCore5_Recv1 */
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore1_Send3_XSignalIsr_OsCore5_Recv1_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore1_Send3_Data[OS_CFG_SIZE_OSCORE1_SEND3_XSIGNALISR_OSCORE5_RECV1_BUFFER];

/* Dynamic X-Signal send port data: OsCore1 -> OsCore0/XSignalIsr_OsCore0_Recv0 */
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore1_Send4_XSignalIsr_OsCore0_Recv0_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore1_Send4_Data[OS_CFG_SIZE_OSCORE1_SEND4_XSIGNALISR_OSCORE0_RECV0_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore1_Recv0 <- OsCore0 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore0_Send4_XSignalIsr_OsCore1_Recv0_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore1_Recv0_Data[OS_CFG_SIZE_OSCORE0_SEND4_XSIGNALISR_OSCORE1_RECV0_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore1_Recv1 <- OsCore2 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore2_Send4_XSignalIsr_OsCore1_Recv1_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore1_Recv1_Data[OS_CFG_SIZE_OSCORE2_SEND4_XSIGNALISR_OSCORE1_RECV1_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore1_Recv2 <- OsCore3 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore3_Send4_XSignalIsr_OsCore1_Recv2_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore1_Recv2_Data[OS_CFG_SIZE_OSCORE3_SEND4_XSIGNALISR_OSCORE1_RECV2_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore1_Recv3 <- OsCore4 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore4_Send4_XSignalIsr_OsCore1_Recv3_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore1_Recv3_Data[OS_CFG_SIZE_OSCORE4_SEND4_XSIGNALISR_OSCORE1_RECV3_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore1_Recv4 <- OsCore5 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore5_Send4_XSignalIsr_OsCore1_Recv4_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore1_Recv4_Data[OS_CFG_SIZE_OSCORE5_SEND4_XSIGNALISR_OSCORE1_RECV4_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore2_Send2_XSignalIsr_OsCore5_Recv2_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore2_Send2_Data[OS_CFG_SIZE_OSCORE2_SEND2_XSIGNALISR_OSCORE5_RECV2_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore2_Send4_XSignalIsr_OsCore1_Recv1_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore2_Send4_Data[OS_CFG_SIZE_OSCORE2_SEND4_XSIGNALISR_OSCORE1_RECV1_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore4_Send0_XSignalIsr_OsCore2_Recv3_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore2_Recv3_Data[OS_CFG_SIZE_OSCORE4_SEND0_XSIGNALISR_OSCORE2_RECV3_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore2_Recv4 <- OsCore5 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore5_Send1_XSignalIsr_OsCore2_Recv4_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore2_Recv4_Data[OS_CFG_SIZE_OSCORE5_SEND1_XSIGNALISR_OSCORE2_RECV4_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore3_Send2_XSignalIsr_OsCore5_Recv3_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore3_Send2_Data[OS_CFG_SIZE_OSCORE3_SEND2_XSIGNALISR_OSCORE5_RECV3_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore3_Send4_XSignalIsr_OsCore1_Recv2_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore3_Send4_Data[OS_CFG_SIZE_OSCORE3_SEND4_XSIGNALISR_OSCORE1_RECV2_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore3_Recv0 <- OsCore0 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore0_Send2_XSignalIsr_OsCore3_Recv0_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore3_Recv0_Data[OS_CFG_SIZE_OSCORE0_SEND2_XSIGNALISR_OSCORE3_RECV0_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore3_Recv1 <- OsCore1 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore1_Send2_XSignalIsr_OsCore3_Recv1_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore3_Recv1_Data[OS_CFG_SIZE_OSCORE1_SEND2_XSIGNALISR_OSCORE3_RECV1_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore4_Send1_XSignalIsr_OsCore3_Recv3_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore3_Recv3_Data[OS_CFG_SIZE_OSCORE4_SEND1_XSIGNALISR_OSCORE3_RECV3_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore3_Recv4 <- OsCore5 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore5_Send2_XSignalIsr_OsCore3_Recv4_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore3_Recv4_Data[OS_CFG_SIZE_OSCORE5_SEND2_XSIGNALISR_OSCORE3_RECV4_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore4_Send0_XSignalIsr_OsCore2_Recv3_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore4_Send0_Data[OS_CFG_SIZE_OSCORE4_SEND0_XSIGNALISR_OSCORE2_RECV3_BUFFER];

/* Dynamic X-Signal send port data: OsCore4 -> OsCore3/XSignalIsr_OsCore3_Recv3 */
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore4_Send1_XSignalIsr_OsCore3_Recv3_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore4_Send1_Data[OS_CFG_SIZE_OSCORE4_SEND1_XSIGNALISR_OSCORE3_RECV3_BUFFER];

/* Dynamic X-Signal send port data: OsCore4 -> OsCore5/XSignalIsr_OsCore5_Recv4 */
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore4_Send2_XSignalIsr_OsCore5_Recv4_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore4_Send2_Data[OS_CFG_SIZE_OSCORE4_SEND2_XSIGNALISR_OSCORE5_RECV4_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore4_Send4_XSignalIsr_OsCore1_Recv3_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore4_Send4_Data[OS_CFG_SIZE_OSCORE4_SEND4_XSIGNALISR_OSCORE1_RECV3_BUFFER];
...
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore5_Send1_XSignalIsr_OsCore2_Recv4_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore5_Send1_Data[OS_CFG_SIZE_OSCORE5_SEND1_XSIGNALISR_OSCORE2_RECV4_BUFFER];

/* Dynamic X-Signal send port data: OsCore5 -> OsCore3/XSignalIsr_OsCore3_Recv4 */
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore5_Send2_XSignalIsr_OsCore3_Recv4_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore5_Send2_Data[OS_CFG_SIZE_OSCORE5_SEND2_XSIGNALISR_OSCORE3_RECV4_BUFFER];

/* Dynamic X-Signal send port data: OsCore5 -> OsCore0/XSignalIsr_OsCore0_Recv4 */
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore5_Send3_XSignalIsr_OsCore0_Recv4_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore5_Send3_Data[OS_CFG_SIZE_OSCORE5_SEND3_XSIGNALISR_OSCORE0_RECV4_BUFFER];

/* Dynamic X-Signal send port data: OsCore5 -> OsCore1/XSignalIsr_OsCore1_Recv4 */
OS_LOCAL VAR(Os_XSigChannelSendType, OS_VAR_NOINIT) OsCfg_XSig_OsCore5_Send4_XSignalIsr_OsCore1_Recv4_Send_Dyn;
OS_LOCAL VAR(Os_XSigSendDataType, OS_VAR_NOINIT)
  OsCore5_Send4_Data[OS_CFG_SIZE_OSCORE5_SEND4_XSIGNALISR_OSCORE1_RECV4_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore5_Recv0 <- OsCore0 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore0_Send3_XSignalIsr_OsCore5_Recv0_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore5_Recv0_Data[OS_CFG_SIZE_OSCORE0_SEND3_XSIGNALISR_OSCORE5_RECV0_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore5_Recv1 <- OsCore1 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore1_Send3_XSignalIsr_OsCore5_Recv1_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore5_Recv1_Data[OS_CFG_SIZE_OSCORE1_SEND3_XSIGNALISR_OSCORE5_RECV1_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore5_Recv2 <- OsCore2 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore2_Send2_XSignalIsr_OsCore5_Recv2_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore5_Recv2_Data[OS_CFG_SIZE_OSCORE2_SEND2_XSIGNALISR_OSCORE5_RECV2_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore5_Recv3 <- OsCore3 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore3_Send2_XSignalIsr_OsCore5_Recv3_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore5_Recv3_Data[OS_CFG_SIZE_OSCORE3_SEND2_XSIGNALISR_OSCORE5_RECV3_BUFFER];

/* Dynamic X-Signal receive port data: XSignalIsr_OsCore5_Recv4 <- OsCore4 */
OS_LOCAL VAR(Os_XSigChannelRecvType, OS_VAR_NOINIT) OsCfg_XSig_OsCore4_Send2_XSignalIsr_OsCore5_Recv4_Recv_Dyn;
OS_LOCAL VAR(Os_XSigRecvDataType, OS_VAR_NOINIT)
  XSignalIsr_OsCore5_Recv4_Data[OS_CFG_SIZE_OSCORE4_SEND2_XSIGNALISR_OSCORE5_RECV4_BUFFER];
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore0_Send2_XSignalIsr_OsCore3_Recv0_Buffer_Dyn[OS_CFG_SIZE_OSCORE0_SEND2_XSIGNALISR_OSCORE3_RECV0_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore0_Send3_XSignalIsr_OsCore5_Recv0_Buffer_Dyn[OS_CFG_SIZE_OSCORE0_SEND3_XSIGNALISR_OSCORE5_RECV0_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore0_Send4_XSignalIsr_OsCore1_Recv0_Buffer_Dyn[OS_CFG_SIZE_OSCORE0_SEND4_XSIGNALISR_OSCORE1_RECV0_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore1_Send2_XSignalIsr_OsCore3_Recv1_Buffer_Dyn[OS_CFG_SIZE_OSCORE1_SEND2_XSIGNALISR_OSCORE3_RECV1_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore1_Send3_XSignalIsr_OsCore5_Recv1_Buffer_Dyn[OS_CFG_SIZE_OSCORE1_SEND3_XSIGNALISR_OSCORE5_RECV1_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore1_Send4_XSignalIsr_OsCore0_Recv0_Buffer_Dyn[OS_CFG_SIZE_OSCORE1_SEND4_XSIGNALISR_OSCORE0_RECV0_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore2_Send2_XSignalIsr_OsCore5_Recv2_Buffer_Dyn[OS_CFG_SIZE_OSCORE2_SEND2_XSIGNALISR_OSCORE5_RECV2_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore2_Send4_XSignalIsr_OsCore1_Recv1_Buffer_Dyn[OS_CFG_SIZE_OSCORE2_SEND4_XSIGNALISR_OSCORE1_RECV1_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore3_Send2_XSignalIsr_OsCore5_Recv3_Buffer_Dyn[OS_CFG_SIZE_OSCORE3_SEND2_XSIGNALISR_OSCORE5_RECV3_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore3_Send4_XSignalIsr_OsCore1_Recv2_Buffer_Dyn[OS_CFG_SIZE_OSCORE3_SEND4_XSIGNALISR_OSCORE1_RECV2_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore4_Send0_XSignalIsr_OsCore2_Recv3_Buffer_Dyn[OS_CFG_SIZE_OSCORE4_SEND0_XSIGNALISR_OSCORE2_RECV3_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore4_Send1_XSignalIsr_OsCore3_Recv3_Buffer_Dyn[OS_CFG_SIZE_OSCORE4_SEND1_XSIGNALISR_OSCORE3_RECV3_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore4_Send2_XSignalIsr_OsCore5_Recv4_Buffer_Dyn[OS_CFG_SIZE_OSCORE4_SEND2_XSIGNALISR_OSCORE5_RECV4_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore4_Send4_XSignalIsr_OsCore1_Recv3_Buffer_Dyn[OS_CFG_SIZE_OSCORE4_SEND4_XSIGNALISR_OSCORE1_RECV3_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore5_Send1_XSignalIsr_OsCore2_Recv4_Buffer_Dyn[OS_CFG_SIZE_OSCORE5_SEND1_XSIGNALISR_OSCORE2_RECV4_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore5_Send2_XSignalIsr_OsCore3_Recv4_Buffer_Dyn[OS_CFG_SIZE_OSCORE5_SEND2_XSIGNALISR_OSCORE3_RECV4_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore5_Send3_XSignalIsr_OsCore0_Recv4_Buffer_Dyn[OS_CFG_SIZE_OSCORE5_SEND3_XSIGNALISR_OSCORE0_RECV4_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigComDataConfigType, OS_CONST) OsCfg_XSig_OsCore5_Send4_XSignalIsr_OsCore1_Recv4_Buffer_Dyn[OS_CFG_SIZE_OSCORE5_SEND4_XSIGNALISR_OSCORE1_RECV4_BUFFER] =
{
  {
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore0_Send2 =
{
  /* .SendChannel = */
  {
    ...
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE0_SEND2_XSIGNALISR_OSCORE3_RECV0_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore0_Send3 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore0_Send3_XSignalIsr_OsCore5_Recv0_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore0_Send3_XSignalIsr_OsCore5_Recv0_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore0_Send3_XSignalIsr_OsCore5_Recv0_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE0_SEND3_XSIGNALISR_OSCORE5_RECV0_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore0_Send4 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore0_Send4_XSignalIsr_OsCore1_Recv0_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore0_Send4_XSignalIsr_OsCore1_Recv0_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore0_Send4_XSignalIsr_OsCore1_Recv0_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE0_SEND4_XSIGNALISR_OSCORE1_RECV0_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore0_Recv0 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore1_Send4_XSignalIsr_OsCore0_Recv0_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore1_Send4_XSignalIsr_OsCore0_Recv0_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore1_Send4_XSignalIsr_OsCore0_Recv0_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE1_SEND4_XSIGNALISR_OSCORE0_RECV0_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore0_Recv4 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore5_Send3_XSignalIsr_OsCore0_Recv4_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore5_Send3_XSignalIsr_OsCore0_Recv4_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore5_Send3_XSignalIsr_OsCore0_Recv4_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE5_SEND3_XSIGNALISR_OSCORE0_RECV4_BUFFER
  },
...
CONST(Os_XSigConfigType, OS_CONST) OsCfg_XSig_OsCore0 =
{
  ...
  {
    /* [0] = */ NULL_PTR, /* OsCore0 */
    /* [1] = */ &OsCfg_XSig_OsCore0_Send4, /* OsCore1 */
    /* [2] = */ &OsCfg_XSig_OsCore0_Send1, /* OsCore2 */
    /* [3] = */ &OsCfg_XSig_OsCore0_Send2, /* OsCore3 */
    /* [4] = */ &OsCfg_XSig_OsCore0_Send0, /* OsCore4 */
    /* [5] = */ &OsCfg_XSig_OsCore0_Send3 /* OsCore5 */
  },
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore1_Send2 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore1_Send2_XSignalIsr_OsCore3_Recv1_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore1_Send2_XSignalIsr_OsCore3_Recv1_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore1_Send2_XSignalIsr_OsCore3_Recv1_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE1_SEND2_XSIGNALISR_OSCORE3_RECV1_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore3,
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore1_Send3 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore1_Send3_XSignalIsr_OsCore5_Recv1_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore1_Send3_XSignalIsr_OsCore5_Recv1_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore1_Send3_XSignalIsr_OsCore5_Recv1_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE1_SEND3_XSIGNALISR_OSCORE5_RECV1_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore5,
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore1_Send4 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore1_Send4_XSignalIsr_OsCore0_Recv0_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore1_Send4_XSignalIsr_OsCore0_Recv0_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore1_Send4_XSignalIsr_OsCore0_Recv0_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE1_SEND4_XSIGNALISR_OSCORE0_RECV0_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore1_Recv0 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore0_Send4_XSignalIsr_OsCore1_Recv0_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore0_Send4_XSignalIsr_OsCore1_Recv0_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore0_Send4_XSignalIsr_OsCore1_Recv0_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE0_SEND4_XSIGNALISR_OSCORE1_RECV0_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore1_Recv1 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore2_Send4_XSignalIsr_OsCore1_Recv1_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore2_Send4_XSignalIsr_OsCore1_Recv1_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore2_Send4_XSignalIsr_OsCore1_Recv1_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE2_SEND4_XSIGNALISR_OSCORE1_RECV1_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore1_Recv2 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore3_Send4_XSignalIsr_OsCore1_Recv2_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore3_Send4_XSignalIsr_OsCore1_Recv2_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore3_Send4_XSignalIsr_OsCore1_Recv2_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE3_SEND4_XSIGNALISR_OSCORE1_RECV2_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore1_Recv3 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore4_Send4_XSignalIsr_OsCore1_Recv3_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore4_Send4_XSignalIsr_OsCore1_Recv3_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore4_Send4_XSignalIsr_OsCore1_Recv3_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE4_SEND4_XSIGNALISR_OSCORE1_RECV3_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore1_Recv4 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore5_Send4_XSignalIsr_OsCore1_Recv4_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore5_Send4_XSignalIsr_OsCore1_Recv4_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore5_Send4_XSignalIsr_OsCore1_Recv4_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE5_SEND4_XSIGNALISR_OSCORE1_RECV4_BUFFER
  },
...
CONST(Os_XSigConfigType, OS_CONST) OsCfg_XSig_OsCore1 =
{
  /* .XSigSendPorts    = */ 
  {
    /* [0] = */ &OsCfg_XSig_OsCore1_Send4, /* OsCore0 */
    /* [1] = */ NULL_PTR, /* OsCore1 */
    /* [2] = */ &OsCfg_XSig_OsCore1_Send1, /* OsCore2 */
    /* [3] = */ &OsCfg_XSig_OsCore1_Send2, /* OsCore3 */
    /* [4] = */ &OsCfg_XSig_OsCore1_Send0, /* OsCore4 */
    /* [5] = */ &OsCfg_XSig_OsCore1_Send3 /* OsCore5 */
  },
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore2_Send2 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore2_Send2_XSignalIsr_OsCore5_Recv2_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore2_Send2_XSignalIsr_OsCore5_Recv2_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore2_Send2_XSignalIsr_OsCore5_Recv2_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE2_SEND2_XSIGNALISR_OSCORE5_RECV2_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore5,
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore2_Send4 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore2_Send4_XSignalIsr_OsCore1_Recv1_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore2_Send4_XSignalIsr_OsCore1_Recv1_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore2_Send4_XSignalIsr_OsCore1_Recv1_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE2_SEND4_XSIGNALISR_OSCORE1_RECV1_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore1,
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore2_Recv3 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore4_Send0_XSignalIsr_OsCore2_Recv3_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore4_Send0_XSignalIsr_OsCore2_Recv3_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore4_Send0_XSignalIsr_OsCore2_Recv3_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE4_SEND0_XSIGNALISR_OSCORE2_RECV3_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore2_Recv4 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore5_Send1_XSignalIsr_OsCore2_Recv4_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore5_Send1_XSignalIsr_OsCore2_Recv4_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore5_Send1_XSignalIsr_OsCore2_Recv4_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE5_SEND1_XSIGNALISR_OSCORE2_RECV4_BUFFER
  },
...
CONST(Os_XSigConfigType, OS_CONST) OsCfg_XSig_OsCore2 =
{
  /* .XSigSendPorts    = */ 
  {
    ...
    /* [1] = */ &OsCfg_XSig_OsCore2_Send4, /* OsCore1 */
    /* [2] = */ NULL_PTR, /* OsCore2 */
    /* [3] = */ &OsCfg_XSig_OsCore2_Send1, /* OsCore3 */
    /* [4] = */ &OsCfg_XSig_OsCore2_Send0, /* OsCore4 */
    /* [5] = */ &OsCfg_XSig_OsCore2_Send2 /* OsCore5 */
  },
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore3_Send2 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore3_Send2_XSignalIsr_OsCore5_Recv3_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore3_Send2_XSignalIsr_OsCore5_Recv3_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore3_Send2_XSignalIsr_OsCore5_Recv3_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE3_SEND2_XSIGNALISR_OSCORE5_RECV3_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore5,
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore3_Send4 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore3_Send4_XSignalIsr_OsCore1_Recv2_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore3_Send4_XSignalIsr_OsCore1_Recv2_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore3_Send4_XSignalIsr_OsCore1_Recv2_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE3_SEND4_XSIGNALISR_OSCORE1_RECV2_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore1,
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore3_Recv1 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore1_Send2_XSignalIsr_OsCore3_Recv1_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore1_Send2_XSignalIsr_OsCore3_Recv1_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore1_Send2_XSignalIsr_OsCore3_Recv1_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE1_SEND2_XSIGNALISR_OSCORE3_RECV1_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore3_Recv3 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore4_Send1_XSignalIsr_OsCore3_Recv3_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore4_Send1_XSignalIsr_OsCore3_Recv3_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore4_Send1_XSignalIsr_OsCore3_Recv3_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE4_SEND1_XSIGNALISR_OSCORE3_RECV3_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore3_Recv4 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore5_Send2_XSignalIsr_OsCore3_Recv4_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore5_Send2_XSignalIsr_OsCore3_Recv4_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore5_Send2_XSignalIsr_OsCore3_Recv4_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE5_SEND2_XSIGNALISR_OSCORE3_RECV4_BUFFER
  },
...
CONST(Os_XSigConfigType, OS_CONST) OsCfg_XSig_OsCore3 =
{
  /* .XSigSendPorts    = */ 
  {
    ...
    /* [1] = */ &OsCfg_XSig_OsCore3_Send4, /* OsCore1 */
    /* [2] = */ &OsCfg_XSig_OsCore3_Send1, /* OsCore2 */
    /* [3] = */ NULL_PTR, /* OsCore3 */
    /* [4] = */ &OsCfg_XSig_OsCore3_Send0, /* OsCore4 */
    /* [5] = */ &OsCfg_XSig_OsCore3_Send2 /* OsCore5 */
  },
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore4_Send0 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore4_Send0_XSignalIsr_OsCore2_Recv3_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore4_Send0_XSignalIsr_OsCore2_Recv3_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore4_Send0_XSignalIsr_OsCore2_Recv3_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE4_SEND0_XSIGNALISR_OSCORE2_RECV3_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore2,
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore4_Send1 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore4_Send1_XSignalIsr_OsCore3_Recv3_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore4_Send1_XSignalIsr_OsCore3_Recv3_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore4_Send1_XSignalIsr_OsCore3_Recv3_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE4_SEND1_XSIGNALISR_OSCORE3_RECV3_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore3,
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore4_Send2 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore4_Send2_XSignalIsr_OsCore5_Recv4_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore4_Send2_XSignalIsr_OsCore5_Recv4_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore4_Send2_XSignalIsr_OsCore5_Recv4_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE4_SEND2_XSIGNALISR_OSCORE5_RECV4_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore5,
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore4_Send4 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore4_Send4_XSignalIsr_OsCore1_Recv3_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore4_Send4_XSignalIsr_OsCore1_Recv3_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore4_Send4_XSignalIsr_OsCore1_Recv3_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE4_SEND4_XSIGNALISR_OSCORE1_RECV3_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore1,
...
CONST(Os_XSigConfigType, OS_CONST) OsCfg_XSig_OsCore4 =
{
  /* .XSigSendPorts    = */ 
  {
    ...
    /* [1] = */ &OsCfg_XSig_OsCore4_Send4, /* OsCore1 */
    /* [2] = */ &OsCfg_XSig_OsCore4_Send0, /* OsCore2 */
    /* [3] = */ &OsCfg_XSig_OsCore4_Send1, /* OsCore3 */
    /* [4] = */ NULL_PTR, /* OsCore4 */
    /* [5] = */ &OsCfg_XSig_OsCore4_Send2 /* OsCore5 */
  },
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore5_Send1 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore5_Send1_XSignalIsr_OsCore2_Recv4_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore5_Send1_XSignalIsr_OsCore2_Recv4_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore5_Send1_XSignalIsr_OsCore2_Recv4_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE5_SEND1_XSIGNALISR_OSCORE2_RECV4_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore2,
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore5_Send2 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore5_Send2_XSignalIsr_OsCore3_Recv4_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore5_Send2_XSignalIsr_OsCore3_Recv4_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore5_Send2_XSignalIsr_OsCore3_Recv4_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE5_SEND2_XSIGNALISR_OSCORE3_RECV4_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore3,
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore5_Send3 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore5_Send3_XSignalIsr_OsCore0_Recv4_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore5_Send3_XSignalIsr_OsCore0_Recv4_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore5_Send3_XSignalIsr_OsCore0_Recv4_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE5_SEND3_XSIGNALISR_OSCORE0_RECV4_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore0,
...
OS_LOCAL CONST(Os_XSigSendPortConfigType, OS_CONST) OsCfg_XSig_OsCore5_Send4 =
{
  /* .SendChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore5_Send4_XSignalIsr_OsCore1_Recv4_Send_Dyn,
    /* .Receive    = */ &OsCfg_XSig_OsCore5_Send4_XSignalIsr_OsCore1_Recv4_Recv_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore5_Send4_XSignalIsr_OsCore1_Recv4_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE5_SEND4_XSIGNALISR_OSCORE1_RECV4_BUFFER
  },
  /* .XSigIsr     = */ &OsCfg_Isr_XSignalIsr_OsCore1,
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore5_Recv0 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore0_Send3_XSignalIsr_OsCore5_Recv0_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore0_Send3_XSignalIsr_OsCore5_Recv0_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore0_Send3_XSignalIsr_OsCore5_Recv0_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE0_SEND3_XSIGNALISR_OSCORE5_RECV0_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore5_Recv1 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore1_Send3_XSignalIsr_OsCore5_Recv1_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore1_Send3_XSignalIsr_OsCore5_Recv1_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore1_Send3_XSignalIsr_OsCore5_Recv1_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE1_SEND3_XSIGNALISR_OSCORE5_RECV1_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore5_Recv2 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore2_Send2_XSignalIsr_OsCore5_Recv2_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore2_Send2_XSignalIsr_OsCore5_Recv2_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore2_Send2_XSignalIsr_OsCore5_Recv2_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE2_SEND2_XSIGNALISR_OSCORE5_RECV2_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore5_Recv3 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore3_Send2_XSignalIsr_OsCore5_Recv3_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore3_Send2_XSignalIsr_OsCore5_Recv3_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore3_Send2_XSignalIsr_OsCore5_Recv3_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE3_SEND2_XSIGNALISR_OSCORE5_RECV3_BUFFER
  },
...
OS_LOCAL CONST(Os_XSigRecvPortConfigType, OS_CONST) OsCfg_XSig_XSignalIsr_OsCore5_Recv4 =
{
  /* .RecvChannel = */
  {
    /* .Dyn        = */ &OsCfg_XSig_OsCore4_Send2_XSignalIsr_OsCore5_Recv4_Recv_Dyn,
    /* .Send       = */ &OsCfg_XSig_OsCore4_Send2_XSignalIsr_OsCore5_Recv4_Send_Dyn,
    /* .Buffer     = */ OsCfg_XSig_OsCore4_Send2_XSignalIsr_OsCore5_Recv4_Buffer_Dyn,
    /* .BufferSize = */ (Os_XSigBufferIdxType)OS_CFG_SIZE_OSCORE4_SEND2_XSIGNALISR_OSCORE5_RECV4_BUFFER
  },
...
CONST(Os_XSigConfigType, OS_CONST) OsCfg_XSig_OsCore5 =
{
  /* .XSigSendPorts    = */ 
  {
    /* [0] = */ &OsCfg_XSig_OsCore5_Send3, /* OsCore0 */
    /* [1] = */ &OsCfg_XSig_OsCore5_Send4, /* OsCore1 */
    /* [2] = */ &OsCfg_XSig_OsCore5_Send1, /* OsCore2 */
    /* [3] = */ &OsCfg_XSig_OsCore5_Send2, /* OsCore3 */
