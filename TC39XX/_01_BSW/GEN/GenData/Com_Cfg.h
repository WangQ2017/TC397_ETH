...
#define ComConf_ComSignal_ComSignalPnc_EIRA_ETH_Rx                    0u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_ComSignalPnc_EIRA_ETH_Tx                    0u
/**\} */
...
#define Com_GetSizeOfRxDefPduBufferOfPCConfig()                                                     7u  /**< the number of accomplishable value elements in Com_RxDefPduBuffer */
...
#define Com_GetSizeOfTxBufferOfPCConfig()                                                           7u  /**< the number of accomplishable value elements in Com_TxBuffer */
...
#define Com_GetSizeOfTxPduInitValueOfPCConfig()                                                     7u  /**< the number of accomplishable value elements in Com_TxPduInitValue */
...
#define Com_GetApplTypeOfRxAccessInfo(Index)                                                        ((Com_ApplTypeOfRxAccessInfoType)((((Com_ApplTypeOfRxAccessInfoType)(Index)) + 0x08u)))  /**< Application data type. */
#define Com_GetBitLengthOfRxAccessInfo(Index)                                                       ((Com_BitLengthOfRxAccessInfoType)((((Com_BitLengthOfRxAccessInfoType)(Index)) + 56u)))  /**< Bit length of the signal or group signal. */
...
#define Com_GetBusAccOfRxAccessInfo(Index)                                                          ((Com_BusAccOfRxAccessInfoType)((((Com_BusAccOfRxAccessInfoType)(Index)) + 0x06u)))  /**< BUS access algorithm for signal or group signal packing / un-packing. */
#define Com_GetByteLengthOfRxAccessInfo(Index)                                                      ((Com_ByteLengthOfRxAccessInfoType)((((Com_ByteLengthOfRxAccessInfoType)(Index)) + 7u)))  /**< Byte length of the signal or group signal. */
...
#define Com_GetConstValueArrayBasedInitValueEndIdxOfRxAccessInfo(Index)                             ((Com_ConstValueArrayBasedInitValueEndIdxOfRxAccessInfoType)((((Com_ConstValueArrayBasedInitValueEndIdxOfRxAccessInfoType)(Index)) + 7u)))  /**< the end index of the 0:n relation pointing to Com_ConstValueArrayBased */
#define Com_GetConstValueArrayBasedInitValueLengthOfRxAccessInfo(Index)                             ((Com_ConstValueArrayBasedInitValueLengthOfRxAccessInfoType)((((Com_ConstValueArrayBasedInitValueLengthOfRxAccessInfoType)(Index)) + 7u)))  /**< the number of relations pointing to Com_ConstValueArrayBased */
#define Com_GetConstValueArrayBasedInitValueStartIdxOfRxAccessInfo(Index)                           ((Com_ConstValueArrayBasedInitValueStartIdxOfRxAccessInfoType)((Index)))  /**< the start index of the 0:n relation pointing to Com_ConstValueArrayBased */
...
#define Com_GetRxSigBufferArrayBasedBufferEndIdxOfRxAccessInfo(Index)                               ((Com_RxSigBufferArrayBasedBufferEndIdxOfRxAccessInfoType)((((Com_RxSigBufferArrayBasedBufferEndIdxOfRxAccessInfoType)(Index)) + 7u)))  /**< the end index of the 0:n relation pointing to Com_RxSigBufferArrayBased */
#define Com_GetRxSigBufferArrayBasedBufferLengthOfRxAccessInfo(Index)                               ((Com_RxSigBufferArrayBasedBufferLengthOfRxAccessInfoType)((((Com_RxSigBufferArrayBasedBufferLengthOfRxAccessInfoType)(Index)) + 7u)))  /**< the number of relations pointing to Com_RxSigBufferArrayBased */
#define Com_GetRxSigBufferArrayBasedBufferStartIdxOfRxAccessInfo(Index)                             ((Com_RxSigBufferArrayBasedBufferStartIdxOfRxAccessInfoType)((Index)))  /**< the start index of the 0:n relation pointing to Com_RxSigBufferArrayBased */
...
#define Com_GetPduGrpVectorEndIdxOfRxPduInfo(Index)                                                 ((Com_PduGrpVectorEndIdxOfRxPduInfoType)((((Com_PduGrpVectorEndIdxOfRxPduInfoType)(Index)) + 1u)))  /**< the end index of the 0:n relation pointing to Com_PduGrpVector */
#define Com_GetPduGrpVectorStartIdxOfRxPduInfo(Index)                                               ((Com_PduGrpVectorStartIdxOfRxPduInfoType)((Index)))  /**< the start index of the 0:n relation pointing to Com_PduGrpVector */
...
#define Com_GetRxDefPduBufferEndIdxOfRxPduInfo(Index)                                               ((Com_RxDefPduBufferEndIdxOfRxPduInfoType)((((Com_RxDefPduBufferEndIdxOfRxPduInfoType)(Index)) + 7u)))  /**< the end index of the 0:n relation pointing to Com_RxDefPduBuffer */
#define Com_GetRxDefPduBufferLengthOfRxPduInfo(Index)                                               ((Com_RxDefPduBufferLengthOfRxPduInfoType)((((Com_RxDefPduBufferLengthOfRxPduInfoType)(Index)) + 7u)))  /**< the number of relations pointing to Com_RxDefPduBuffer */
...
#define Com_GetPduGrpVectorEndIdxOfTxPduInfo(Index)                                                 ((Com_PduGrpVectorEndIdxOfTxPduInfoType)((((Com_PduGrpVectorEndIdxOfTxPduInfoType)(Index)) + 2u)))  /**< the end index of the 0:n relation pointing to Com_PduGrpVector */
#define Com_GetPduGrpVectorStartIdxOfTxPduInfo(Index)                                               ((Com_PduGrpVectorStartIdxOfTxPduInfoType)((((Com_PduGrpVectorStartIdxOfTxPduInfoType)(Index)) + 1u)))  /**< the start index of the 0:n relation pointing to Com_PduGrpVector */
...
#define Com_GetTxBufferEndIdxOfTxPduInfo(Index)                                                     ((Com_TxBufferEndIdxOfTxPduInfoType)((((Com_TxBufferEndIdxOfTxPduInfoType)(Index)) + 7u)))  /**< the end index of the 0:n relation pointing to Com_TxBuffer */
...
#define Com_GetTxPduInitValueEndIdxOfTxPduInfo(Index)                                               ((Com_TxPduInitValueEndIdxOfTxPduInfoType)((((Com_TxPduInitValueEndIdxOfTxPduInfoType)(Index)) + 7u)))  /**< the end index of the 0:n relation pointing to Com_TxPduInitValue */
...
#define Com_GetApplTypeOfTxSigInfo(Index)                                                           ((Com_ApplTypeOfTxSigInfoType)((((Com_ApplTypeOfTxSigInfoType)(Index)) + 0x08u)))  /**< Application data type. */
#define Com_GetBitLengthOfTxSigInfo(Index)                                                          ((Com_BitLengthOfTxSigInfoType)((((Com_BitLengthOfTxSigInfoType)(Index)) + 56u)))  /**< Bit length of the signal or group signal. */
...
#define Com_GetBusAccOfTxSigInfo(Index)                                                             ((Com_BusAccOfTxSigInfoType)((((Com_BusAccOfTxSigInfoType)(Index)) + 0x06u)))  /**< BUS access algorithm for signal or group signal packing / un-packing. */
#define Com_GetByteLengthOfTxSigInfo(Index)                                                         ((Com_ByteLengthOfTxSigInfoType)((((Com_ByteLengthOfTxSigInfoType)(Index)) + 7u)))  /**< Byte length of the signal or group signal. */
...
#define Com_GetTxBufferEndIdxOfTxSigInfo(Index)                                                     ((Com_TxBufferEndIdxOfTxSigInfoType)((((Com_TxBufferEndIdxOfTxSigInfoType)(Index)) + 7u)))  /**< the end index of the 0:n relation pointing to Com_TxBuffer */
#define Com_GetTxBufferLengthOfTxSigInfo(Index)                                                     ((Com_TxBufferLengthOfTxSigInfoType)((((Com_TxBufferLengthOfTxSigInfoType)(Index)) + 7u)))  /**< the number of relations pointing to Com_TxBuffer */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_TxPduInitValueType, COM_CONST) Com_TxPduInitValue[7];
#define COM_STOP_SEC_CONST_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Com_TxBufferType, COM_VAR_NOINIT) Com_TxBuffer[7];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
