...
#define NVM_SELECT_BLOCK_FOR_WRITEALL_ON         (32u)
#define NVM_SELECT_BLOCK_FOR_WRITEALL_OFF        (0u)
#define NVM_INVOKE_CALLBACKS_FOR_READALL_ON      (64u)
#define NVM_INVOKE_CALLBACKS_FOR_READALL_OFF     (0u)
#define NVM_INVOKE_CALLBACKS_FOR_WRITEALL_ON     (128u)
#define NVM_INVOKE_CALLBACKS_FOR_WRITEALL_OFF    (0u)
#define NVM_BLOCK_USE_SET_RAM_BLOCK_STATUS_ON    (256u)
