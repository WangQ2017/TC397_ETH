 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dcm_Lcfg.c
 *   Generation Time: 2026-06-14 14:59:44
...
{
   { ((Dcm_DidMgrOpFuncType)(Rte_Call_DataServices_DcmDspData_NetPara_ReadData)),   8u,   8u,0x0002u} /* DID: 0x016F */                              /* PRQA S 0313 */ /* MD_Dcm_0313 */
  ,{ ((Dcm_DidMgrOpFuncType)(Rte_Call_DataServices_DcmDspData_NetPara_ConditionCheckRead)),   0u,   0u,0x0201u} /* DID: 0x016F */                    /* PRQA S 0313 */ /* MD_Dcm_0313 */
  ,{ ((Dcm_DidMgrOpFuncType)(Rte_Call_DataServices_DcmDspData_NetPara_WriteData)),   8u,   8u,0x1002u} /* DID: 0x016F */                             /* PRQA S 0313 */ /* MD_Dcm_0313 */
};
/*! RID properties */
...
{
   { ((Dcm_RidMgrOpFuncType)(Dcm_RidMgr_0250_Start)),   1u,   1u,   0u,   0u, 9u} /* RID: 0x0250 */                                                  /* PRQA S 0313 */ /* MD_Dcm_0313 */
  ,{ ((Dcm_RidMgrOpFuncType)(Rte_Call_RoutineServices_DcmDspRoutine_0x250_SetPhyTxMode_RequestResults)),   0u,   0u,   0u,   0u, 0u} /* RID: 0x0250 */ /* PRQA S 0313 */ /* MD_Dcm_0313 */
};
...
DCM_LOCAL FUNC(Std_ReturnType, DCM_CALLOUT_CODE) Dcm_RidMgr_0250_Start(Dcm_OpStatusType OpStatus, Dcm_MsgContextPtrType pMsgContext, Dcm_RidMgrRidLengthPtrType DataLength, Dcm_NegativeResponseCodePtrType ErrorCode) /* PRQA S 3673 */ /* MD_Dcm_APIStd_3673 */
{
  ...
  dataInTxMode = ((uint8)(Dcm_DiagGetReqDataAsU8Rel(pMsgContext, 0u)))                                                                               /* PRQA S 2985 */ /* MD_Dcm_Redundant_2985 */;

  DCM_IGNORE_UNREF_PARAM(DataLength);                                                                                                                /* PRQA S 3112 */ /* MD_Dcm_3112 */

  return Rte_Call_RoutineServices_DcmDspRoutine_0x250_SetPhyTxMode_Start(dataInTxMode
                                                                        , OpStatus
                                                                        , ErrorCode
