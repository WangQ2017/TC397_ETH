...
CONST(TcpIp_ArpConfigType, TCPIP_CONST) TcpIp_ArpConfig[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */        6000u,          400u,     1000u,               TRUE,                        0u,           200u,       10u }   /* [/ActiveEcuC/TcpIp/TcpIpConfig/TcpIpIpConfig/TcpIpIpV4Config/TcpIpArpConfig] */
};
...
CONST(TcpIp_TcpConfigType, TCPIP_CONST) TcpIp_TcpConfig[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */      1440000u,          24000u, 24000u,             1200u, 1460u, 1460u,                4000u,                0u,                 0u,          20u,            20u,                      5u,                      5u,           10u,               64u, TCPIP_NO_USERTIMEOUTMAXCYCLESOFTCPCONFIG, TCPIP_NO_USERTIMEOUTMINCYCLESOFTCPCONFIG }
};
#define TCPIP_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
VAR(TcpIp_ArpTableEntryUType, TCPIP_VAR_NOINIT) TcpIp_ArpTableEntry;  /* PRQA S 0759, 1514, 1533 */  /* MD_CSL_Union, MD_CSL_ObjectOnlyAccessedOnce, MD_CSL_ObjectOnlyAccessedOnce */
  ...
  /*   ... */  /* [/ActiveEcuC/TcpIp/TcpIpConfig/TcpIpCtrl_untagged] */
  /*     9 */  /* [/ActiveEcuC/TcpIp/TcpIpConfig/TcpIpCtrl_untagged] */
