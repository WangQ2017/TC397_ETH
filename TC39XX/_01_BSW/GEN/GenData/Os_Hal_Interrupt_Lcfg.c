...
CONST(Os_Hal_IntIsrConfigType, OS_CONST) OsCfg_Hal_IntIsr_EthIsr_EthCtrlConfig_MAIN_EthInterruptServiceRoutine_Q0Tx =
{
  /* .Level          = */ 50,
  /* .Source         = */ 0x588uL,
  /* .CoreAssignment = */ 0
...
CONST(Os_Hal_IntIsrMapConfigType, OS_CONST) OsCfg_Hal_IntIsrMap_EthIsr_EthCtrlConfig_MAIN_EthInterruptServiceRoutine_Q0Tx =
{
  /* .Dummy         = */ (uint32)0
};

/*! HAL ISR configuration data: EthIsr_PPS */
CONST(Os_Hal_IntIsrConfigType, OS_CONST) OsCfg_Hal_IntIsr_EthIsr_PPS =
{
  /* .Level          = */ 130,
  /* .Source         = */ 0x584uL,
  /* .CoreAssignment = */ 0
...
CONST(Os_Hal_IntIsrMapConfigType, OS_CONST) OsCfg_Hal_IntIsrMap_EthIsr_PPS =
{
  /* .Dummy         = */ (uint32)0
};
