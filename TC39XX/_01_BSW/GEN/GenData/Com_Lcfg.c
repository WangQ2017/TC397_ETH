...
CONST(Com_RxAccessInfoType, COM_CONST) Com_RxAccessInfo[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    RxSigBufferArrayBasedBufferUsed        Referable Keys */
  { /*     0 */                            TRUE }   /* [/ActiveEcuC/Com/ComConfig/ComSignalPnc_EIRA_ETH_Rx, /ActiveEcuC/Com/ComConfig/ComIPduPnc_EIRA_ETH_Rx] */
};
...
CONST(Com_RxPduInfoType, COM_CONST) Com_RxPduInfo[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */             TRUE }   /* [/ActiveEcuC/Com/ComConfig/ComIPduPnc_EIRA_ETH_Rx, /ActiveEcuC/Com/ComConfig/ComIPduGroup_Rx_PNC00, /ActiveEcuC/Com/ComConfig/ComIPduGroup_Rx_PNC_All_Active] */
};
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(Com_TxPduInfoType, COM_CONST) Com_TxPduInfo[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */         TRUE }   /* [/ActiveEcuC/Com/ComConfig/ComIPduPnc_EIRA_ETH_Tx, /ActiveEcuC/Com/ComConfig/ComIPduGroup_Tx_PNC00, /ActiveEcuC/Com/ComConfig/ComIPduGroup_Tx_PNC_All_Active] */
};
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(Com_TxPduInitValueType, COM_CONST) Com_TxPduInitValue[7] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
VAR(Com_TxBufferType, COM_VAR_NOINIT) Com_TxBuffer[7];  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  /* Index        Referable Keys */
