...
# define OS_ISR_ASCLIN0ERR_ISR_CORE      (0)
# define OS_ISR_ASCLIN0ERR_ISR_LEVEL     (128)
# define OS_ISR_ASCLIN0TX_ISR_CORE      (0)
# define OS_ISR_ASCLIN0TX_ISR_LEVEL     (129)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE0_CORE      (0)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE0_LEVEL     (100)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE1_CORE      (1)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE1_LEVEL     (100)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE2_CORE      (2)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE2_LEVEL     (100)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE3_CORE      (3)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE3_LEVEL     (100)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE4_CORE      (4)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE4_LEVEL     (100)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE5_CORE      (6)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_OSCORE5_LEVEL     (100)
# define OS_ISR_ETHISR_ETHCTRLCONFIG_MAIN_ETHINTERRUPTSERVICEROUTINE_CORE      (0)
# define OS_ISR_ETHISR_ETHCTRLCONFIG_MAIN_ETHINTERRUPTSERVICEROUTINE_LEVEL     (50)
