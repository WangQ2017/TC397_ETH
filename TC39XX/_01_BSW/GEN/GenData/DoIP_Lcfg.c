...
#define DoIPTester_DoIPTester_0x0E80 0u
...
CONST(DoIP_ChannelType, DOIP_CONST) DoIP_Channel[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */ 0x1212u,    4095u,  PduRConf_PduRSrcPdu_PduRSrcPdu_DoIPPhyReqRx, PduRConf_PduRDestPdu_PduRDestPdu_DoIPPhyResTx },  /* [/ActiveEcuC/DoIP/DoIPConfigSet/DoIPChannel_DOIP_Phy_Req, /ActiveEcuC/DoIP/DoIPConfigSet/DoIPRoutingActivation] */
...
CONST(DoIP_ConnectionType, DOIP_CONST) DoIP_Connection[4] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */           0u,                  SoAdConf_SoAdSocketRouteDest_SoAdSocketRouteDest_DOIP_TCP_DATA0_Rx,                  SoAdConf_SoAdPduRoute_SoAdPduRoute_DOIP_TCP_DATA0_Tx },  /* [/ActiveEcuC/TcpIp/TcpIpConfig/TcpIpLocalAddr_NE_DhcpV4_Fixed_169_254_1_33] */
  { /*     1 */           0u,                  SoAdConf_SoAdSocketRouteDest_SoAdSocketRouteDest_DOIP_TCP_DATA1_Rx,                  SoAdConf_SoAdPduRoute_SoAdPduRoute_DOIP_TCP_DATA1_Tx },  /* [/ActiveEcuC/TcpIp/TcpIpConfig/TcpIpLocalAddr_NE_DhcpV4_Fixed_169_254_1_33] */
  { /*     2 */           0u, SoAdConf_SoAdSocketRouteDest_SoAdSocketRouteDest_DOIP_UDP_TEST_EQUIPMENT_REQUEST_Rx, SoAdConf_SoAdPduRoute_SoAdPduRoute_DOIP_UDP_TEST_EQUIPMENT_REQUEST_Tx },  /* [/ActiveEcuC/TcpIp/TcpIpConfig/TcpIpLocalAddr_NE_DhcpV4_Fixed_169_254_1_33] */
...
CONST(DoIP_ConnectionTcpType, DOIP_CONST) DoIP_ConnectionTcp[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */            FALSE,                 0u,               0u,               0u },  /* [/ActiveEcuC/DoIP/DoIPConfigSet/DoIPConnections/DoIPTcpConnection_TCP_DATA0, /ActiveEcuC/SoAd/SoAdConfig/SCG_DOIP_TCP_DhcpV4_Fixed_169_254_1_33_13400] */
  { /*     1 */            FALSE,                 0u,              19u,               2u }   /* [/ActiveEcuC/DoIP/DoIPConfigSet/DoIPConnections/DoIPTcpConnection_TCP_DATA1, /ActiveEcuC/SoAd/SoAdConfig/SCG_DOIP_TCP_DhcpV4_Fixed_169_254_1_33_13400] */
};
#define DOIP_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(DoIP_EIdType, DOIP_CONST) DoIP_EId[5] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  /* Index     EId    */
  /*     0 */  0xA5u,
  /*     1 */  0xA5u,
  /*     2 */  0xA5u,
...
CONST(DoIP_RoutingActivationType, DOIP_CONST) DoIP_RoutingActivation[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */ NULL_PTR   , NULL_PTR              , NULL_PTR   , NULL_PTR               }   /* [/ActiveEcuC/DoIP/DoIPConfigSet/DoIPRoutingActivation, /ActiveEcuC/DoIP/DoIPConfigSet/DoIPTester_0x0E80] */
};
#define DOIP_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
VAR(DoIP_ConnectionTcpDynType, DOIP_VAR_NOINIT) DoIP_ConnectionTcpDyn[2];  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  /* Index        Referable Keys */
  /*     0 */  /* [/ActiveEcuC/DoIP/DoIPConfigSet/DoIPConnections/DoIPTcpConnection_TCP_DATA0, /ActiveEcuC/SoAd/SoAdConfig/SCG_DOIP_TCP_DhcpV4_Fixed_169_254_1_33_13400] */
  /*     1 */  /* [/ActiveEcuC/DoIP/DoIPConfigSet/DoIPConnections/DoIPTcpConnection_TCP_DATA1, /ActiveEcuC/SoAd/SoAdConfig/SCG_DOIP_TCP_DhcpV4_Fixed_169_254_1_33_13400] */
...
VAR(DoIP_TesterDynUType, DOIP_VAR_NOINIT) DoIP_TesterDyn;  /* PRQA S 0759, 1514, 1533 */  /* MD_CSL_Union, MD_CSL_ObjectOnlyAccessedOnce, MD_CSL_ObjectOnlyAccessedOnce */
  /* Index        Referable Keys */
  /*     0 */  /* [/ActiveEcuC/DoIP/DoIPConfigSet/DoIPTester_0x0E80] */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
VAR(DoIP_TxUdpMgtListType, DOIP_VAR_NOINIT) DoIP_TxUdpMgtList[4];  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
#define DOIP_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
CONST(DoIP_PCConfigsType, DOIP_CONST) DoIP_PCConfig = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  { /* Index: 0 Keys: [Config] */
    ...
    , 5u                            /**< the number of elements in DoIP_EId */
    ...
    , 4u                            /**< the number of elements in DoIP_TxUdpMgtList */
  }
};
#define DOIP_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
