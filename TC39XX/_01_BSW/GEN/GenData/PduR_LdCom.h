 ...
 *           The PDU Router evaluates the LdCom I-PDU handle and identifies the destination(s) of the PDU.\n
 *           The call is routed to a lower IF module using the appropriate I-PDU handle of the destination layer.
 * \param    id                ID of the LdCom I-PDU to be transmitted
 ...
 *                             or the LdComTxPduId is not valid\n
 *                             or the LdComTxPduId is not forwarded in this identity\n
