...
# define OS_START_SEC_EthIsr_EthCtrlConfig_MAIN_EthInterruptServiceRoutine_Q0Tx_CODE
# include "Os_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
...
# define OS_START_SEC_EthIsr_PPS_CODE
# include "Os_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */

/**********************************************************************************************************************
 *  EthIsr_PPS()
 *********************************************************************************************************************/
extern FUNC(void, OS_ETHISR_PPS_CODE) Os_Isr_EthIsr_PPS(void);

# define OS_STOP_SEC_EthIsr_PPS_CODE
# include "Os_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
