...
#define SD_SET_REM_ADDR_OF_CLIENT_RX_MULTICAST_SOCON       STD_ON
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define SdConf_SdClientService_SdCLientService_0xC3CB_VechicleSpeed   0u
#define SdConf_SdClientService_SdCLientService_0xC3CD_VechicleInfo    1u
...
#define SdConf_SdConsumedEventGroup_SdConsumedEventGroup_0xC3CC_VechicleStatus 2u
#define SdConf_SdConsumedEventGroup_SdConsumedEventGroup_0xC3CD_VechicleInfo 1u
/**\} */
