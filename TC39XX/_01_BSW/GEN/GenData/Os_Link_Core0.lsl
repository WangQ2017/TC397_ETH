...
if (exists(".text.OS_OsIsr_PPS_CODE"))
{
  group OS_OsIsr_PPS_CODE_GROUP(align=8)
  {
    select "[.]text.OS_OsIsr_PPS_CODE";
  }
  "_OS_OsIsr_PPS_CODE_START" = "_lc_gb_OS_OsIsr_PPS_CODE_GROUP";
  "_OS_OsIsr_PPS_CODE_END" = "_lc_ge_OS_OsIsr_PPS_CODE_GROUP" - 1;
  "_OS_OsIsr_PPS_CODE_LIMIT" = "_lc_ge_OS_OsIsr_PPS_CODE_GROUP";
}
else
{
  "_OS_OsIsr_PPS_CODE_START" = 0;
  "_OS_OsIsr_PPS_CODE_END" = 0;
  "_OS_OsIsr_PPS_CODE_LIMIT" = 0;
}
...
#if defined ( OS_LINK_CONST ) || defined ( OS_LINK_CONST_ISR ) || defined ( OS_LINK_CONST_ISR_OSISR_PPS ) || defined ( OS_LINK_CONST_ISR_OSISR_PPS_FAR )
if (exists(".rodata.OS_OsIsr_PPS_CONST"))
{
  group OS_OsIsr_PPS_CONST_GROUP(ordered, contiguous, fill, align=8)
  {
    select "[.]rodata.OS_OsIsr_PPS_CONST";
  }
  "_OS_OsIsr_PPS_CONST_START" = "_lc_gb_OS_OsIsr_PPS_CONST_GROUP";
  "_OS_OsIsr_PPS_CONST_END" = "_lc_ge_OS_OsIsr_PPS_CONST_GROUP" - 1;
  "_OS_OsIsr_PPS_CONST_LIMIT" = "_lc_ge_OS_OsIsr_PPS_CONST_GROUP";
}
else
{
  "_OS_OsIsr_PPS_CONST_START" = 0;
  "_OS_OsIsr_PPS_CONST_END" = 0;
  "_OS_OsIsr_PPS_CONST_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_CONST ) || defined ( OS_LINK_CONST_ISR ) || defined ( OS_LINK_CONST_ISR_OSISR_PPS ) || defined ( OS_LINK_CONST_ISR_OSISR_PPS_NEAR )
if (exists(".zrodata.OS_OsIsr_PPS_CONST_FAST"))
{
  group OS_OsIsr_PPS_CONST_FAST_GROUP(ordered, contiguous, fill, align=8)
  {
    select "[.]zrodata.OS_OsIsr_PPS_CONST_FAST";
  }
  "_OS_OsIsr_PPS_CONST_FAST_START" = "_lc_gb_OS_OsIsr_PPS_CONST_FAST_GROUP";
  "_OS_OsIsr_PPS_CONST_FAST_END" = "_lc_ge_OS_OsIsr_PPS_CONST_FAST_GROUP" - 1;
  "_OS_OsIsr_PPS_CONST_FAST_LIMIT" = "_lc_ge_OS_OsIsr_PPS_CONST_FAST_GROUP";
}
else
{
  "_OS_OsIsr_PPS_CONST_FAST_START" = 0;
  "_OS_OsIsr_PPS_CONST_FAST_END" = 0;
  "_OS_OsIsr_PPS_CONST_FAST_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_CONST ) || defined ( OS_LINK_CONST_ISR ) || defined ( OS_LINK_CONST_ISR_OSISR_PPS ) || defined ( OS_LINK_CONST_ISR_OSISR_PPS_INIT )
...
#ifdef OS_LINK_CONST_ISR_OSISR_PPS
# undef OS_LINK_CONST_ISR_OSISR_PPS
#endif

#ifdef OS_LINK_CONST_ISR_OSISR_PPS_FAR
# undef OS_LINK_CONST_ISR_OSISR_PPS_FAR
#endif

#ifdef OS_LINK_CONST_ISR_OSISR_PPS_NEAR
# undef OS_LINK_CONST_ISR_OSISR_PPS_NEAR
#endif

#ifdef OS_LINK_CONST_ISR_OSISR_PPS_INIT
# undef OS_LINK_CONST_ISR_OSISR_PPS_INIT
#endif
...
#ifdef OS_LINK_VAR_ISR_OSISR_PPS
group OS_OsIsr_PPS_VAR_ALL_GROUP(ordered, contiguous, fill, align=8)
{
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE_INIT )
if (exists(".data.OS_OsIsr_PPS_VAR"))
{
  group OS_OsIsr_PPS_VAR_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]data.OS_OsIsr_PPS_VAR";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_START" = "_lc_gb_OS_OsIsr_PPS_VAR_GROUP";
  "_OS_OsIsr_PPS_VAR_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR" - 1;
  "_OS_OsIsr_PPS_VAR_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR";
}
else
{
  "_OS_OsIsr_PPS_VAR_START" = 0;
  "_OS_OsIsr_PPS_VAR_END" = 0;
  "_OS_OsIsr_PPS_VAR_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE_NOINIT )
if (exists(".bss.OS_OsIsr_PPS_VAR_NOINIT"))
{
  group OS_OsIsr_PPS_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]bss.OS_OsIsr_PPS_VAR_NOINIT";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_NOINIT" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_NOINIT_START" = "_lc_gb_OS_OsIsr_PPS_VAR_NOINIT_GROUP";
  "_OS_OsIsr_PPS_VAR_NOINIT_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_NOINIT" - 1;
  "_OS_OsIsr_PPS_VAR_NOINIT_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_NOINIT";
}
else
{
  "_OS_OsIsr_PPS_VAR_NOINIT_START" = 0;
  "_OS_OsIsr_PPS_VAR_NOINIT_END" = 0;
  "_OS_OsIsr_PPS_VAR_NOINIT_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE_ZERO_INIT )
if (exists(".bss.OS_OsIsr_PPS_VAR_ZERO_INIT_bss") || exists(".data.OS_OsIsr_PPS_VAR_ZERO_INIT"))
{
  group OS_OsIsr_PPS_VAR_ZERO_INIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_ZERO_INIT_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]bss.OS_OsIsr_PPS_VAR_ZERO_INIT_bss";
      select "[.]data.OS_OsIsr_PPS_VAR_ZERO_INIT";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_ZERO_INIT" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_ZERO_INIT_START" = "_lc_gb_OS_OsIsr_PPS_VAR_ZERO_INIT_GROUP";
  "_OS_OsIsr_PPS_VAR_ZERO_INIT_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_ZERO_INIT" - 1;
  "_OS_OsIsr_PPS_VAR_ZERO_INIT_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_ZERO_INIT";
}
else
{
  "_OS_OsIsr_PPS_VAR_ZERO_INIT_START" = 0;
  "_OS_OsIsr_PPS_VAR_ZERO_INIT_END" = 0;
  "_OS_OsIsr_PPS_VAR_ZERO_INIT_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE_INIT )
if (exists(".zdata.OS_OsIsr_PPS_VAR_FAST"))
{
  group OS_OsIsr_PPS_VAR_FAST_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_FAST_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]zdata.OS_OsIsr_PPS_VAR_FAST";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_FAST" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_FAST_START" = "_lc_gb_OS_OsIsr_PPS_VAR_FAST_GROUP";
  "_OS_OsIsr_PPS_VAR_FAST_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST" - 1;
  "_OS_OsIsr_PPS_VAR_FAST_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST";
}
else
{
  "_OS_OsIsr_PPS_VAR_FAST_START" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_END" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE_NOINIT )
if (exists(".zbss.OS_OsIsr_PPS_VAR_FAST_NOINIT"))
{
  group OS_OsIsr_PPS_VAR_FAST_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_FAST_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]zbss.OS_OsIsr_PPS_VAR_FAST_NOINIT";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_FAST_NOINIT" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_FAST_NOINIT_START" = "_lc_gb_OS_OsIsr_PPS_VAR_FAST_NOINIT_GROUP";
  "_OS_OsIsr_PPS_VAR_FAST_NOINIT_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST_NOINIT" - 1;
  "_OS_OsIsr_PPS_VAR_FAST_NOINIT_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST_NOINIT";
}
else
{
  "_OS_OsIsr_PPS_VAR_FAST_NOINIT_START" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_NOINIT_END" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_NOINIT_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE_ZERO_INIT )
if (exists(".zbss.OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_bss") || exists(".zdata.OS_OsIsr_PPS_VAR_FAST_ZERO_INIT"))
{
  group OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]zbss.OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_bss";
      select "[.]zdata.OS_OsIsr_PPS_VAR_FAST_ZERO_INIT";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_FAST_ZERO_INIT" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_START" = "_lc_gb_OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_GROUP";
  "_OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST_ZERO_INIT" - 1;
  "_OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST_ZERO_INIT";
}
else
{
  "_OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_START" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_END" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_ZERO_INIT_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE_INIT )
if (exists(".data.OS_OsIsr_PPS_VAR_NOCACHE"))
{
  group OS_OsIsr_PPS_VAR_NOCACHE_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_NOCACHE_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]data.OS_OsIsr_PPS_VAR_NOCACHE";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_NOCACHE" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_NOCACHE_START" = "_lc_gb_OS_OsIsr_PPS_VAR_NOCACHE_GROUP";
  "_OS_OsIsr_PPS_VAR_NOCACHE_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_NOCACHE" - 1;
  "_OS_OsIsr_PPS_VAR_NOCACHE_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_NOCACHE";
}
else
{
  "_OS_OsIsr_PPS_VAR_NOCACHE_START" = 0;
  "_OS_OsIsr_PPS_VAR_NOCACHE_END" = 0;
  "_OS_OsIsr_PPS_VAR_NOCACHE_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE_NOINIT )
if (exists(".bss.OS_OsIsr_PPS_VAR_NOCACHE_NOINIT"))
{
  group OS_OsIsr_PPS_VAR_NOCACHE_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_NOCACHE_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]bss.OS_OsIsr_PPS_VAR_NOCACHE_NOINIT";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_NOCACHE_NOINIT" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_NOCACHE_NOINIT_START" = "_lc_gb_OS_OsIsr_PPS_VAR_NOCACHE_NOINIT_GROUP";
  "_OS_OsIsr_PPS_VAR_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_NOCACHE_NOINIT" - 1;
  "_OS_OsIsr_PPS_VAR_NOCACHE_NOINIT_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_NOCACHE_NOINIT";
}
else
{
  "_OS_OsIsr_PPS_VAR_NOCACHE_NOINIT_START" = 0;
  "_OS_OsIsr_PPS_VAR_NOCACHE_NOINIT_END" = 0;
  "_OS_OsIsr_PPS_VAR_NOCACHE_NOINIT_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE_ZERO_INIT )
if (exists(".bss.OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_bss") || exists(".data.OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT"))
{
  group OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]bss.OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_bss";
      select "[.]data.OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_START" = "_lc_gb_OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_GROUP";
  "_OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT" - 1;
  "_OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT";
}
else
{
  "_OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_START" = 0;
  "_OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_END" = 0;
  "_OS_OsIsr_PPS_VAR_NOCACHE_ZERO_INIT_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE_INIT )
if (exists(".zdata.OS_OsIsr_PPS_VAR_FAST_NOCACHE"))
{
  group OS_OsIsr_PPS_VAR_FAST_NOCACHE_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_FAST_NOCACHE_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]zdata.OS_OsIsr_PPS_VAR_FAST_NOCACHE";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_FAST_NOCACHE" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_START" = "_lc_gb_OS_OsIsr_PPS_VAR_FAST_NOCACHE_GROUP";
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST_NOCACHE" - 1;
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST_NOCACHE";
}
else
{
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_START" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_END" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE_NOINIT )
if (exists(".zbss.OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT"))
{
  group OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]zbss.OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT_START" = "_lc_gb_OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT_GROUP";
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT" - 1;
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT";
}
else
{
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT_START" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT_END" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_NOINIT_LIMIT" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_ISR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE ) || defined ( OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE_ZERO_INIT )
if (exists(".zbss.OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_bss") || exists(".zdata.OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT"))
{
  group OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_SECTION" (blocksize=2, attributes=rw)
    {
      select "[.]zbss.OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_bss";
      select "[.]zdata.OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT";
    }
    reserved ".pad.OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT" (size=16);
  }
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_START" = "_lc_gb_OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_GROUP";
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_END" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT" - 1;
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_LIMIT" = "_lc_ub__pad_OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT";
}
else
{
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_START" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_END" = 0;
  "_OS_OsIsr_PPS_VAR_FAST_NOCACHE_ZERO_INIT_LIMIT" = 0;
}
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS
} /* OS_OsIsr_PPS_VAR_ALL_GROUP */
"_OS_OsIsr_PPS_VAR_ALL_START" = "_lc_gb_OS_OsIsr_PPS_VAR_ALL_GROUP";
"_OS_OsIsr_PPS_VAR_ALL_END" = "_lc_ge_OS_OsIsr_PPS_VAR_ALL_GROUP" - 1;
"_OS_OsIsr_PPS_VAR_ALL_LIMIT" = "_lc_ge_OS_OsIsr_PPS_VAR_ALL_GROUP";

# undef OS_LINK_VAR_ISR_OSISR_PPS
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_FAR
# undef OS_LINK_VAR_ISR_OSISR_PPS_FAR
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE
# undef OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE_INIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE_INIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE_NOINIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE_NOINIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE_ZERO_INIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_FAR_CACHE_ZERO_INIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE
# undef OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE_INIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE_INIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE_NOINIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE_NOINIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE_ZERO_INIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_FAR_NOCACHE_ZERO_INIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_NEAR
# undef OS_LINK_VAR_ISR_OSISR_PPS_NEAR
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE
# undef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE_INIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE_INIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE_NOINIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE_NOINIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE_ZERO_INIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_CACHE_ZERO_INIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE
# undef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE_INIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE_INIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE_NOINIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE_NOINIT
#endif

#ifdef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE_ZERO_INIT
# undef OS_LINK_VAR_ISR_OSISR_PPS_NEAR_NOCACHE_ZERO_INIT
#endif
