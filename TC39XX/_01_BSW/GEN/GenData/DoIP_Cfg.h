...
#define DoIPConf_DoIPPduRRxPdu_DoIPPduRRxPdu                          0u
#define DoIPConf_DoIPPduRRxPdu_DoIPPduRRxPdu_001                      1u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define DoIPConf_DoIPPduRTxPdu_DoIPPduRTxPdu                          0u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define DoIPConf_DoIPSoAdTcpRxPdu_DoIPSoAdTcpRxPdu                    0u
#define DoIPConf_DoIPSoAdTcpRxPdu_DoIPSoAdTcpRxPdu_1                  1u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define DoIPConf_DoIPSoAdTcpTxPdu_DoIPSoAdTcpTxPdu                    0u
#define DoIPConf_DoIPSoAdTcpTxPdu_DoIPSoAdTcpTxPdu_1                  1u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define DoIPConf_DoIPSoAdUdpRxPdu_DoIPSoAdUdpRxPdu                    2u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define DoIPConf_DoIPSoAdUdpTxPdu_DoIPSoAdUdpTxPdu                    2u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define DoIPConf_DoIPSoAdUdpVehicleAnnouncementTxPdu_DoIPSoAdUdpVehicleAnnouncementTxPdu 3u
/**\} */
...
# define DOIP_NODE                               1U
# define DOIP_NODE_TYPE                          DOIP_GATEWAY
