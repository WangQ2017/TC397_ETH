...
class SOMEIPSD_Server:
    ...
    def create_event_message(self, service_config, payload):
        ...
        soad_header[4] = (len(pdu_payload) >> 24) & 0xFF
        soad_header[5] = (len(pdu_payload) >> 16) & 0xFF
        soad_header[6] = (len(pdu_payload) >> 8) & 0xFF
        soad_header[7] = len(pdu_payload) & 0xFF
        
        return bytes(soad_header) + pdu_payload
