...
extern void Streamimg_Notification00(Uart_ErrorIdType ErrorId,Uart_SizeType RxDataSize);
/*
...
[/cover] */
static const Uart_ChannelConfigType  Uart_ChannelConfig[2] =
{
  ...
  /* UART Channel ID: 1 Configuration */
  { /* Notification function */
    {
      /* Call-back notification function for write operation */
      NULL_PTR,
